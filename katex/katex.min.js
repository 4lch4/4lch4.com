!(function (e, t) {
  ...
  return (function () {
    ...
    var c = (function () {
        function e(e) {
          ...
          h))
            if (h.hasOwnProperty(t)) {
              var r = h[t]
              this[t] = void 0 !== e[t] ? (r.processor ? r.processor(e[t]) : e[t]) : m(r)
            }
        }
        var t = e.prototype
        return (
      ...
      b = [1, 1, 3, 3, 5, 5, 7, 7],
      y = [0, 1, 2, 3, 2, 3, 2, 3],
      x = { DISPLAY: p[0], TEXT: p[2], SCRIPT: p[4], SCRIPTSCRIPT: p[6] },
      w = [
        {
          name: 'latin',
          blocks: [
    ...
    var k = []
    function S(e) {
      for (var t = 0; t < k.length; t += 2) if (e >= k[t] && e <= k[t + 1]) return !0
      return !1
    }
    ...
    function q(e, t, r) {
      ...
      var n = e.charCodeAt(0),
        a = T[t][n]
      if (
        (!a && e[0] in C && ((n = C[e[0]].charCodeAt(0)), (a = T[t][n])),
        a || 'text' !== r || (S(n) && (a = T[t][77])),
        a)
      )
    ...
    var I = [
      ...
      R = [0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.44, 1.728, 2.074, 2.488],
      O = function (e, t) {
      ...
      H = (function () {
        function e(t) {
          ;(this.style = void 0),
            ...
            (this.sizeMultiplier = R[this.size - 1]),
        ...
        return (
          ...
          (t.havingStyle = function (e) {
            return this.style === e ? this : this.extend({ style: e, size: O(this.textSize, e) })
          }),
          ...
          (t.havingBaseStyle = function (t) {
            ...
            return this.size === r && this.textSize === e.BASESIZE && this.style === t
              ? this
              ...
              this._fontMetrics ||
                (this._fontMetrics = (function (e) {
                  ...
                  if (!N[(t = e >= 5 ? 0 : e >= 3 ? 1 : 2)]) {
                    var r = (N[t] = { cssEmPerMu: B.quad[t] / 18 })
    ...
    var E = H,
      ...
      F = function (e, t) {
        ...
        if (e.unit in L) r = L[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier
          ...
          var a
          if (((a = t.style.isTight() ? t.havingStyle(t.style.text()) : t), 'ex' === e.unit))
      ...
      Y = function (e) {
        ...
        for (var r in ((t.className = G(this.classes)), this.style))
      ...
      X = function (e) {
        ...
        for (var a in (r && (t += ' style="' + l.escape(r) + '"'), this.attributes))
          this.attributes.hasOwnProperty(a) &&
            (t += ' ' + a + '="' + l.escape(this.attributes[a]) + '"')
        t += '>'
        ...
        return (
          ...
          (t.toNode = function () {
            ...
            this.classes.length > 0 &&
              ((t = t || document.createElement('span')).className = G(this.classes)),
            this.style))
          ...
          (t.toMarkup = function () {
            var e = !1,
              t = '<span'
            this.classes.length &&
              ((e = !0), (t += ' class="'), (t += l.escape(G(this.classes))), (t += '"'))
            var r = ''
    ...
    var te = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
      re = { 'accent-token': 1, mathord: 1, 'op-token': 1, spacing: 1, textord: 1 },
      ne = { math: {}, text: {} },
      ae = ne
    function ie(e, t, r, n, a, i) {
      ;(ne[e][a] = { font: t, group: r, replace: n }), i && n && (ne[e][n] = ne[e][a])
    }
    var oe = 'math',
      se = 'text',
      le = 'main',
    ...
    ie(oe, le, be, '\u2261', '\\equiv', !0),
      ...
      ie(oe, le, be, '\u223c', '\\sim', !0),
      ie(oe, le, be, '\u22a5', '\\perp'),
      ie(oe, le, be, '\u2aaf', '\\preceq', !0),
      ie(oe, le, be, '\u2ab0', '\\succeq', !0),
      ie(oe, le, be, '\u2243', '\\simeq', !0),
      ie(oe, le, be, '\u2223', '\\mid', !0),
      ie(oe, le, be, '\u226a', '\\ll', !0),
      ie(oe, le, be, '\u226b', '\\gg', !0),
      ie(oe, le, be, '\u224d', '\\asymp', !0),
      ie(oe, le, be, '\u2225', '\\parallel'),
      ie(oe, le, be, '\u22c8', '\\bowtie', !0),
      ie(oe, le, be, '\u2323', '\\smile', !0),
      ie(oe, le, be, '\u2291', '\\sqsubseteq', !0),
      ie(oe, le, be, '\u2292', '\\sqsupseteq', !0),
      ie(oe, le, be, '\u2250', '\\doteq', !0),
      ie(oe, le, be, '\u2322', '\\frown', !0),
      ie(oe, le, be, '\u220b', '\\ni', !0),
      ie(oe, le, be, '\u221d', '\\propto', !0),
      ie(oe, le, be, '\u22a2', '\\vdash', !0),
      ie(oe, le, be, '\u22a3', '\\dashv', !0),
      ie(oe, le, be, '\u220b', '\\owns'),
      ie(oe, le, ve, '.', '\\ldotp'),
      ...
      ie(oe, le, xe, '&', '\\&'),
      ie(se, le, xe, '&', '\\&'),
      ie(oe, le, xe, '\u2135', '\\aleph', !0),
      ie(oe, le, xe, '\u2200', '\\forall', !0),
      ie(oe, le, xe, '\u210f', '\\hbar', !0),
      ie(oe, le, xe, '\u2203', '\\exists', !0),
      ie(oe, le, xe, '\u2207', '\\nabla', !0),
      ie(oe, le, xe, '\u266d', '\\flat', !0),
      ie(oe, le, xe, '\u2113', '\\ell', !0),
      ie(oe, le, xe, '\u266e', '\\natural', !0),
      ie(oe, le, xe, '\u2663', '\\clubsuit', !0),
      ie(oe, le, xe, '\u2118', '\\wp', !0),
      ie(oe, le, xe, '\u266f', '\\sharp', !0),
      ie(oe, le, xe, '\u2662', '\\diamondsuit', !0),
      ie(oe, le, xe, '\u211c', '\\Re', !0),
      ie(oe, le, xe, '\u2661', '\\heartsuit', !0),
      ie(oe, le, xe, '\u2111', '\\Im', !0),
      ie(oe, le, xe, '\u2660', '\\spadesuit', !0),
      ie(oe, le, xe, '\xa7', '\\S', !0),
      ie(se, le, xe, '\xa7', '\\S'),
      ie(oe, le, xe, '\xb6', '\\P', !0),
      ie(se, le, xe, '\xb6', '\\P'),
      ie(oe, le, xe, '\u2020', '\\dag'),
      ie(se, le, xe, '\u2020', '\\dag'),
      ie(se, le, xe, '\u2020', '\\textdagger'),
      ie(oe, le, xe, '\u2021', '\\ddag'),
      ie(se, le, xe, '\u2021', '\\ddag'),
      ie(se, le, xe, '\u2021', '\\textdaggerdbl'),
      ie(oe, le, ue, '\u23b1', '\\rmoustache', !0),
      ie(oe, le, ge, '\u23b0', '\\lmoustache', !0),
      ie(oe, le, ue, '\u27ef', '\\rgroup', !0),
      ie(oe, le, ge, '\u27ee', '\\lgroup', !0),
      ie(oe, le, ce, '\u2213', '\\mp', !0),
      ie(oe, le, ce, '\u2296', '\\ominus', !0),
      ie(oe, le, ce, '\u228e', '\\uplus', !0),
      ie(oe, le, ce, '\u2293', '\\sqcap', !0),
      ie(oe, le, ce, '\u2217', '\\ast'),
      ie(oe, le, ce, '\u2294', '\\sqcup', !0),
      ie(oe, le, ce, '\u25ef', '\\bigcirc', !0),
      ie(oe, le, ce, '\u2219', '\\bullet', !0),
      ie(oe, le, ce, '\u2021', '\\ddagger'),
      ie(oe, le, ce, '\u2240', '\\wr', !0),
      ie(oe, le, ce, '\u2a3f', '\\amalg'),
      ie(oe, le, ce, '&', '\\And'),
      ie(oe, le, be, '\u27f5', '\\longleftarrow', !0),
      ie(oe, le, be, '\u21d0', '\\Leftarrow', !0),
      ie(oe, le, be, '\u27f8', '\\Longleftarrow', !0),
      ie(oe, le, be, '\u27f6', '\\longrightarrow', !0),
      ie(oe, le, be, '\u21d2', '\\Rightarrow', !0),
      ie(oe, le, be, '\u27f9', '\\Longrightarrow', !0),
      ie(oe, le, be, '\u2194', '\\leftrightarrow', !0),
      ie(oe, le, be, '\u27f7', '\\longleftrightarrow', !0),
      ie(oe, le, be, '\u21d4', '\\Leftrightarrow', !0),
      ie(oe, le, be, '\u27fa', '\\Longleftrightarrow', !0),
      ie(oe, le, be, '\u21a6', '\\mapsto', !0),
      ie(oe, le, be, '\u27fc', '\\longmapsto', !0),
      ie(oe, le, be, '\u2197', '\\nearrow', !0),
      ie(oe, le, be, '\u21a9', '\\hookleftarrow', !0),
      ie(oe, le, be, '\u21aa', '\\hookrightarrow', !0),
      ie(oe, le, be, '\u2198', '\\searrow', !0),
      ie(oe, le, be, '\u21bc', '\\leftharpoonup', !0),
      ie(oe, le, be, '\u21c0', '\\rightharpoonup', !0),
      ie(oe, le, be, '\u2199', '\\swarrow', !0),
      ie(oe, le, be, '\u21bd', '\\leftharpoondown', !0),
      ie(oe, le, be, '\u21c1', '\\rightharpoondown', !0),
      ie(oe, le, be, '\u2196', '\\nwarrow', !0),
      ie(oe, le, be, '\u21cc', '\\rightleftharpoons', !0),
      ie(oe, he, be, '\u226e', '\\nless', !0),
      ie(oe, he, be, '\ue010', '\\@nleqslant'),
      ie(oe, he, be, '\ue011', '\\@nleqq'),
      ie(oe, he, be, '\u2a87', '\\lneq', !0),
      ie(oe, he, be, '\u2268', '\\lneqq', !0),
      ie(oe, he, be, '\ue00c', '\\@lvertneqq'),
      ie(oe, he, be, '\u22e6', '\\lnsim', !0),
      ie(oe, he, be, '\u2a89', '\\lnapprox', !0),
      ie(oe, he, be, '\u2280', '\\nprec', !0),
      ie(oe, he, be, '\u22e0', '\\npreceq', !0),
      ie(oe, he, be, '\u22e8', '\\precnsim', !0),
      ie(oe, he, be, '\u2ab9', '\\precnapprox', !0),
      ie(oe, he, be, '\u2241', '\\nsim', !0),
      ie(oe, he, be, '\ue006', '\\@nshortmid'),
      ie(oe, he, be, '\u2224', '\\nmid', !0),
      ie(oe, he, be, '\u22ac', '\\nvdash', !0),
      ie(oe, he, be, '\u22ad', '\\nvDash', !0),
      ie(oe, he, be, '\u22ea', '\\ntriangleleft'),
      ie(oe, he, be, '\u22ec', '\\ntrianglelefteq', !0),
      ie(oe, he, be, '\u228a', '\\subsetneq', !0),
      ie(oe, he, be, '\ue01a', '\\@varsubsetneq'),
      ie(oe, he, be, '\u2acb', '\\subsetneqq', !0),
      ie(oe, he, be, '\ue017', '\\@varsubsetneqq'),
      ie(oe, he, be, '\u226f', '\\ngtr', !0),
      ie(oe, he, be, '\ue00f', '\\@ngeqslant'),
      ie(oe, he, be, '\ue00e', '\\@ngeqq'),
      ie(oe, he, be, '\u2a88', '\\gneq', !0),
      ie(oe, he, be, '\u2269', '\\gneqq', !0),
      ie(oe, he, be, '\ue00d', '\\@gvertneqq'),
      ie(oe, he, be, '\u22e7', '\\gnsim', !0),
      ie(oe, he, be, '\u2a8a', '\\gnapprox', !0),
      ie(oe, he, be, '\u2281', '\\nsucc', !0),
      ie(oe, he, be, '\u22e1', '\\nsucceq', !0),
      ie(oe, he, be, '\u22e9', '\\succnsim', !0),
      ie(oe, he, be, '\u2aba', '\\succnapprox', !0),
      ie(oe, he, be, '\u2246', '\\ncong', !0),
      ie(oe, he, be, '\ue007', '\\@nshortparallel'),
      ie(oe, he, be, '\u2226', '\\nparallel', !0),
      ie(oe, he, be, '\u22af', '\\nVDash', !0),
      ie(oe, he, be, '\u22eb', '\\ntriangleright'),
      ie(oe, he, be, '\u22ed', '\\ntrianglerighteq', !0),
      ie(oe, he, be, '\ue018', '\\@nsupseteqq'),
      ie(oe, he, be, '\u228b', '\\supsetneq', !0),
      ie(oe, he, be, '\ue01b', '\\@varsupsetneq'),
      ie(oe, he, be, '\u2acc', '\\supsetneqq', !0),
      ie(oe, he, be, '\ue019', '\\@varsupsetneqq'),
      ie(oe, he, be, '\u22ae', '\\nVdash', !0),
      ie(oe, he, be, '\u2ab5', '\\precneqq', !0),
      ie(oe, he, be, '\u2ab6', '\\succneqq', !0),
      ie(oe, he, be, '\ue016', '\\@nsubseteqq'),
      ie(oe, he, ce, '\u22b4', '\\unlhd'),
      ie(oe, he, ce, '\u22b5', '\\unrhd'),
      ie(oe, he, be, '\u219a', '\\nleftarrow', !0),
      ie(oe, he, be, '\u219b', '\\nrightarrow', !0),
      ...
      ie(oe, he, be, '\u21ae', '\\nleftrightarrow', !0),
      ie(oe, he, be, '\u21ce', '\\nLeftrightarrow', !0),
      ie(oe, he, be, '\u25b3', '\\vartriangle'),
      ie(oe, he, xe, '\u210f', '\\hslash'),
      ie(oe, he, xe, '\u25bd', '\\triangledown'),
      ie(oe, he, xe, '\u25ca', '\\lozenge'),
      ie(oe, he, xe, '\u24c8', '\\circledS'),
      ie(oe, he, xe, '\xae', '\\circledR'),
      ie(se, he, xe, '\xae', '\\circledR'),
      ie(oe, he, xe, '\u2221', '\\measuredangle', !0),
      ie(oe, he, xe, '\u2204', '\\nexists'),
      ie(oe, he, xe, '\u2127', '\\mho'),
      ie(oe, he, xe, '\u2132', '\\Finv', !0),
      ie(oe, he, xe, '\u2141', '\\Game', !0),
      ie(oe, he, xe, '\u2035', '\\backprime'),
      ie(oe, he, xe, '\u25b2', '\\blacktriangle'),
      ie(oe, he, xe, '\u25bc', '\\blacktriangledown'),
      ie(oe, he, xe, '\u25a0', '\\blacksquare'),
      ie(oe, he, xe, '\u29eb', '\\blacklozenge'),
      ie(oe, he, xe, '\u2605', '\\bigstar'),
      ie(oe, he, xe, '\u2222', '\\sphericalangle', !0),
      ie(oe, he, xe, '\u2201', '\\complement', !0),
      ie(oe, he, xe, '\xf0', '\\eth', !0),
      ie(se, le, xe, '\xf0', '\xf0'),
      ie(oe, he, xe, '\u2571', '\\diagup'),
      ie(oe, he, xe, '\u2572', '\\diagdown'),
      ie(oe, he, xe, '\u25a1', '\\square'),
      ie(oe, he, xe, '\u25a1', '\\Box'),
      ie(oe, he, xe, '\u25ca', '\\Diamond'),
      ie(oe, he, xe, '\xa5', '\\yen', !0),
      ie(se, he, xe, '\xa5', '\\yen', !0),
      ie(oe, he, xe, '\u2713', '\\checkmark', !0),
      ie(se, he, xe, '\u2713', '\\checkmark'),
      ie(oe, he, xe, '\u2136', '\\beth', !0),
      ie(oe, he, xe, '\u2138', '\\daleth', !0),
      ie(oe, he, xe, '\u2137', '\\gimel', !0),
      ie(oe, he, xe, '\u03dd', '\\digamma', !0),
      ie(oe, he, xe, '\u03f0', '\\varkappa'),
      ie(oe, he, ge, '\u250c', '\\@ulcorner', !0),
      ie(oe, he, ue, '\u2510', '\\@urcorner', !0),
      ie(oe, he, ge, '\u2514', '\\@llcorner', !0),
      ie(oe, he, ue, '\u2518', '\\@lrcorner', !0),
      ie(oe, he, be, '\u2266', '\\leqq', !0),
      ie(oe, he, be, '\u2a7d', '\\leqslant', !0),
      ie(oe, he, be, '\u2a95', '\\eqslantless', !0),
      ie(oe, he, be, '\u2272', '\\lesssim', !0),
      ie(oe, he, be, '\u2a85', '\\lessapprox', !0),
      ie(oe, he, be, '\u224a', '\\approxeq', !0),
      ie(oe, he, ce, '\u22d6', '\\lessdot'),
      ie(oe, he, be, '\u22d8', '\\lll', !0),
      ie(oe, he, be, '\u2276', '\\lessgtr', !0),
      ie(oe, he, be, '\u22da', '\\lesseqgtr', !0),
      ie(oe, he, be, '\u2a8b', '\\lesseqqgtr', !0),
      ie(oe, he, be, '\u2251', '\\doteqdot'),
      ie(oe, he, be, '\u2253', '\\risingdotseq', !0),
      ie(oe, he, be, '\u2252', '\\fallingdotseq', !0),
      ie(oe, he, be, '\u223d', '\\backsim', !0),
      ie(oe, he, be, '\u22cd', '\\backsimeq', !0),
      ie(oe, he, be, '\u2ac5', '\\subseteqq', !0),
      ie(oe, he, be, '\u22d0', '\\Subset', !0),
      ie(oe, he, be, '\u228f', '\\sqsubset', !0),
      ie(oe, he, be, '\u227c', '\\preccurlyeq', !0),
      ie(oe, he, be, '\u22de', '\\curlyeqprec', !0),
      ie(oe, he, be, '\u227e', '\\precsim', !0),
      ie(oe, he, be, '\u2ab7', '\\precapprox', !0),
      ie(oe, he, be, '\u22b2', '\\vartriangleleft'),
      ie(oe, he, be, '\u22b4', '\\trianglelefteq'),
      ie(oe, he, be, '\u22a8', '\\vDash', !0),
      ie(oe, he, be, '\u22aa', '\\Vvdash', !0),
      ie(oe, he, be, '\u2323', '\\smallsmile'),
      ie(oe, he, be, '\u2322', '\\smallfrown'),
      ie(oe, he, be, '\u224f', '\\bumpeq', !0),
      ie(oe, he, be, '\u224e', '\\Bumpeq', !0),
      ie(oe, he, be, '\u2267', '\\geqq', !0),
      ie(oe, he, be, '\u2a7e', '\\geqslant', !0),
      ie(oe, he, be, '\u2a96', '\\eqslantgtr', !0),
      ie(oe, he, be, '\u2273', '\\gtrsim', !0),
      ie(oe, he, be, '\u2a86', '\\gtrapprox', !0),
      ie(oe, he, ce, '\u22d7', '\\gtrdot'),
      ie(oe, he, be, '\u22d9', '\\ggg', !0),
      ie(oe, he, be, '\u2277', '\\gtrless', !0),
      ie(oe, he, be, '\u22db', '\\gtreqless', !0),
      ie(oe, he, be, '\u2a8c', '\\gtreqqless', !0),
      ie(oe, he, be, '\u2256', '\\eqcirc', !0),
      ie(oe, he, be, '\u2257', '\\circeq', !0),
      ie(oe, he, be, '\u225c', '\\triangleq', !0),
      ie(oe, he, be, '\u223c', '\\thicksim'),
      ie(oe, he, be, '\u2248', '\\thickapprox'),
      ie(oe, he, be, '\u2ac6', '\\supseteqq', !0),
      ie(oe, he, be, '\u22d1', '\\Supset', !0),
      ie(oe, he, be, '\u2290', '\\sqsupset', !0),
      ie(oe, he, be, '\u227d', '\\succcurlyeq', !0),
      ie(oe, he, be, '\u22df', '\\curlyeqsucc', !0),
      ie(oe, he, be, '\u227f', '\\succsim', !0),
      ie(oe, he, be, '\u2ab8', '\\succapprox', !0),
      ie(oe, he, be, '\u22b3', '\\vartriangleright'),
      ie(oe, he, be, '\u22b5', '\\trianglerighteq'),
      ie(oe, he, be, '\u22a9', '\\Vdash', !0),
      ie(oe, he, be, '\u2223', '\\shortmid'),
      ie(oe, he, be, '\u2225', '\\shortparallel'),
      ie(oe, he, be, '\u226c', '\\between', !0),
      ie(oe, he, be, '\u22d4', '\\pitchfork', !0),
      ie(oe, he, be, '\u221d', '\\varpropto'),
      ie(oe, he, be, '\u25c0', '\\blacktriangleleft'),
      ie(oe, he, be, '\u2234', '\\therefore', !0),
      ie(oe, he, be, '\u220d', '\\backepsilon'),
      ie(oe, he, be, '\u25b6', '\\blacktriangleright'),
      ie(oe, he, be, '\u2235', '\\because', !0),
      ie(oe, he, be, '\u22d8', '\\llless'),
      ie(oe, he, be, '\u22d9', '\\gggtr'),
      ie(oe, he, ce, '\u22b2', '\\lhd'),
      ie(oe, he, ce, '\u22b3', '\\rhd'),
      ...
      ie(oe, le, be, '\u22c8', '\\Join'),
      ie(oe, he, be, '\u2251', '\\Doteq', !0),
      ie(oe, he, ce, '\u2214', '\\dotplus', !0),
      ie(oe, he, ce, '\u2216', '\\smallsetminus'),
      ie(oe, he, ce, '\u22d2', '\\Cap', !0),
      ie(oe, he, ce, '\u22d3', '\\Cup', !0),
      ie(oe, he, ce, '\u2a5e', '\\doublebarwedge', !0),
      ie(oe, he, ce, '\u229f', '\\boxminus', !0),
      ie(oe, he, ce, '\u229e', '\\boxplus', !0),
      ie(oe, he, ce, '\u22c7', '\\divideontimes', !0),
      ie(oe, he, ce, '\u22c9', '\\ltimes', !0),
      ie(oe, he, ce, '\u22ca', '\\rtimes', !0),
      ie(oe, he, ce, '\u22cb', '\\leftthreetimes', !0),
      ie(oe, he, ce, '\u22cc', '\\rightthreetimes', !0),
      ie(oe, he, ce, '\u22cf', '\\curlywedge', !0),
      ie(oe, he, ce, '\u22ce', '\\curlyvee', !0),
      ie(oe, he, ce, '\u229d', '\\circleddash', !0),
      ie(oe, he, ce, '\u229b', '\\circledast', !0),
      ie(oe, he, ce, '\u22c5', '\\centerdot'),
      ie(oe, he, ce, '\u22ba', '\\intercal', !0),
      ie(oe, he, ce, '\u22d2', '\\doublecap'),
      ie(oe, he, ce, '\u22d3', '\\doublecup'),
      ie(oe, he, ce, '\u22a0', '\\boxtimes', !0),
      ie(oe, he, be, '\u21e2', '\\dashrightarrow', !0),
      ie(oe, he, be, '\u21e0', '\\dashleftarrow', !0),
      ie(oe, he, be, '\u21c7', '\\leftleftarrows', !0),
      ie(oe, he, be, '\u21c6', '\\leftrightarrows', !0),
      ie(oe, he, be, '\u21da', '\\Lleftarrow', !0),
      ie(oe, he, be, '\u219e', '\\twoheadleftarrow', !0),
      ie(oe, he, be, '\u21a2', '\\leftarrowtail', !0),
      ie(oe, he, be, '\u21ab', '\\looparrowleft', !0),
      ie(oe, he, be, '\u21cb', '\\leftrightharpoons', !0),
      ie(oe, he, be, '\u21b6', '\\curvearrowleft', !0),
      ie(oe, he, be, '\u21ba', '\\circlearrowleft', !0),
      ie(oe, he, be, '\u21b0', '\\Lsh', !0),
      ie(oe, he, be, '\u21c8', '\\upuparrows', !0),
      ie(oe, he, be, '\u21bf', '\\upharpoonleft', !0),
      ie(oe, he, be, '\u21c3', '\\downharpoonleft', !0),
      ie(oe, le, be, '\u22b6', '\\origof', !0),
      ie(oe, le, be, '\u22b7', '\\imageof', !0),
      ie(oe, he, be, '\u22b8', '\\multimap', !0),
      ie(oe, he, be, '\u21ad', '\\leftrightsquigarrow', !0),
      ie(oe, he, be, '\u21c9', '\\rightrightarrows', !0),
      ie(oe, he, be, '\u21c4', '\\rightleftarrows', !0),
      ie(oe, he, be, '\u21a0', '\\twoheadrightarrow', !0),
      ie(oe, he, be, '\u21a3', '\\rightarrowtail', !0),
      ie(oe, he, be, '\u21ac', '\\looparrowright', !0),
      ie(oe, he, be, '\u21b7', '\\curvearrowright', !0),
      ie(oe, he, be, '\u21bb', '\\circlearrowright', !0),
      ie(oe, he, be, '\u21b1', '\\Rsh', !0),
      ie(oe, he, be, '\u21ca', '\\downdownarrows', !0),
      ie(oe, he, be, '\u21be', '\\upharpoonright', !0),
      ie(oe, he, be, '\u21c2', '\\downharpoonright', !0),
      ie(oe, he, be, '\u21dd', '\\rightsquigarrow', !0),
      ie(oe, he, be, '\u21dd', '\\leadsto'),
      ie(oe, he, be, '\u21db', '\\Rrightarrow', !0),
      ie(oe, he, be, '\u21be', '\\restriction'),
      ie(oe, le, xe, '\u2018', '`'),
      ie(oe, le, xe, '$', '\\$'),
      ie(se, le, xe, '$', '\\$'),
      ie(se, le, xe, '$', '\\textdollar'),
      ie(oe, le, xe, '%', '\\%'),
      ie(se, le, xe, '%', '\\%'),
      ie(oe, le, xe, '_', '\\_'),
      ie(se, le, xe, '_', '\\_'),
      ie(se, le, xe, '_', '\\textunderscore'),
      ie(oe, le, xe, '\u2220', '\\angle', !0),
      ie(oe, le, xe, '\u221e', '\\infty', !0),
      ie(oe, le, xe, '\u2032', '\\prime'),
      ie(oe, le, xe, '\u25b3', '\\triangle'),
      ie(oe, le, xe, '\u0393', '\\Gamma', !0),
      ie(oe, le, xe, '\u0394', '\\Delta', !0),
      ie(oe, le, xe, '\u0398', '\\Theta', !0),
      ie(oe, le, xe, '\u039b', '\\Lambda', !0),
      ie(oe, le, xe, '\u039e', '\\Xi', !0),
      ie(oe, le, xe, '\u03a0', '\\Pi', !0),
      ie(oe, le, xe, '\u03a3', '\\Sigma', !0),
      ie(oe, le, xe, '\u03a5', '\\Upsilon', !0),
      ie(oe, le, xe, '\u03a6', '\\Phi', !0),
      ie(oe, le, xe, '\u03a8', '\\Psi', !0),
      ie(oe, le, xe, '\u03a9', '\\Omega', !0),
      ie(oe, le, xe, 'A', '\u0391'),
      ie(oe, le, xe, 'B', '\u0392'),
      ie(oe, le, xe, 'E', '\u0395'),
      ie(oe, le, xe, 'Z', '\u0396'),
      ...
      ie(oe, le, xe, 'X', '\u03a7'),
      ie(oe, le, xe, '\xac', '\\neg', !0),
      ie(oe, le, xe, '\xac', '\\lnot'),
      ie(oe, le, xe, '\u22a4', '\\top'),
      ie(oe, le, xe, '\u22a5', '\\bot'),
      ie(oe, le, xe, '\u2205', '\\emptyset'),
      ie(oe, he, xe, '\u2205', '\\varnothing'),
      ie(oe, le, de, '\u03b1', '\\alpha', !0),
      ie(oe, le, de, '\u03b2', '\\beta', !0),
      ie(oe, le, de, '\u03b3', '\\gamma', !0),
      ie(oe, le, de, '\u03b4', '\\delta', !0),
      ie(oe, le, de, '\u03f5', '\\epsilon', !0),
      ie(oe, le, de, '\u03b6', '\\zeta', !0),
      ie(oe, le, de, '\u03b7', '\\eta', !0),
      ie(oe, le, de, '\u03b8', '\\theta', !0),
      ie(oe, le, de, '\u03b9', '\\iota', !0),
      ie(oe, le, de, '\u03ba', '\\kappa', !0),
      ie(oe, le, de, '\u03bb', '\\lambda', !0),
      ie(oe, le, de, '\u03bc', '\\mu', !0),
      ie(oe, le, de, '\u03bd', '\\nu', !0),
      ie(oe, le, de, '\u03be', '\\xi', !0),
      ie(oe, le, de, '\u03bf', '\\omicron', !0),
      ie(oe, le, de, '\u03c0', '\\pi', !0),
      ie(oe, le, de, '\u03c1', '\\rho', !0),
      ie(oe, le, de, '\u03c3', '\\sigma', !0),
      ie(oe, le, de, '\u03c4', '\\tau', !0),
      ie(oe, le, de, '\u03c5', '\\upsilon', !0),
      ie(oe, le, de, '\u03d5', '\\phi', !0),
      ie(oe, le, de, '\u03c7', '\\chi', !0),
      ie(oe, le, de, '\u03c8', '\\psi', !0),
      ie(oe, le, de, '\u03c9', '\\omega', !0),
      ie(oe, le, de, '\u03b5', '\\varepsilon', !0),
      ie(oe, le, de, '\u03d1', '\\vartheta', !0),
      ie(oe, le, de, '\u03d6', '\\varpi', !0),
      ie(oe, le, de, '\u03f1', '\\varrho', !0),
      ie(oe, le, de, '\u03c2', '\\varsigma', !0),
      ie(oe, le, de, '\u03c6', '\\varphi', !0),
      ie(oe, le, ce, '\u2217', '*', !0),
      ie(oe, le, ce, '+', '+'),
      ie(oe, le, ce, '\u2212', '-', !0),
      ie(oe, le, ce, '\u22c5', '\\cdot', !0),
      ie(oe, le, ce, '\u2218', '\\circ', !0),
      ie(oe, le, ce, '\xf7', '\\div', !0),
      ie(oe, le, ce, '\xb1', '\\pm', !0),
      ie(oe, le, ce, '\xd7', '\\times', !0),
      ie(oe, le, ce, '\u2229', '\\cap', !0),
      ie(oe, le, ce, '\u222a', '\\cup', !0),
      ie(oe, le, ce, '\u2216', '\\setminus', !0),
      ie(oe, le, ce, '\u2227', '\\land'),
      ie(oe, le, ce, '\u2228', '\\lor'),
      ie(oe, le, ce, '\u2227', '\\wedge', !0),
      ie(oe, le, ce, '\u2228', '\\vee', !0),
      ie(oe, le, xe, '\u221a', '\\surd'),
      ie(oe, le, ge, '\u27e8', '\\langle', !0),
      ie(oe, le, ge, '\u2223', '\\lvert'),
      ie(oe, le, ge, '\u2225', '\\lVert'),
      ie(oe, le, ue, '?', '?'),
      ie(oe, le, ue, '!', '!'),
      ie(oe, le, ue, '\u27e9', '\\rangle', !0),
      ie(oe, le, ue, '\u2223', '\\rvert'),
      ie(oe, le, ue, '\u2225', '\\rVert'),
      ie(oe, le, be, '=', '='),
      ie(oe, le, be, ':', ':'),
      ie(oe, le, be, '\u2248', '\\approx', !0),
      ie(oe, le, be, '\u2245', '\\cong', !0),
      ie(oe, le, be, '\u2265', '\\ge'),
      ie(oe, le, be, '\u2265', '\\geq', !0),
      ie(oe, le, be, '\u2190', '\\gets'),
      ...
      ie(oe, le, be, '\u2208', '\\in', !0),
      ie(oe, le, be, '\ue020', '\\@not'),
      ie(oe, le, be, '\u2282', '\\subset', !0),
      ie(oe, le, be, '\u2283', '\\supset', !0),
      ie(oe, le, be, '\u2286', '\\subseteq', !0),
      ie(oe, le, be, '\u2287', '\\supseteq', !0),
      ie(oe, he, be, '\u2288', '\\nsubseteq', !0),
      ie(oe, he, be, '\u2289', '\\nsupseteq', !0),
      ie(oe, le, be, '\u22a8', '\\models'),
      ie(oe, le, be, '\u2190', '\\leftarrow', !0),
      ...
      ie(oe, he, be, '\u2270', '\\nleq', !0),
      ie(oe, le, ye, '\xa0', '\\ '),
      ie(oe, le, ye, '\xa0', '\\space'),
      ie(oe, le, ye, '\xa0', '\\nobreakspace'),
      ie(se, le, ye, '\xa0', '\\ '),
      ie(se, le, ye, '\xa0', ' '),
      ie(se, le, ye, '\xa0', '\\space'),
      ie(se, le, ye, '\xa0', '\\nobreakspace'),
      ie(oe, le, ye, null, '\\nobreak'),
      ie(oe, le, ye, null, '\\allowbreak'),
      ie(oe, le, ve, ',', ','),
      ie(oe, le, ve, ';', ';'),
      ie(oe, he, ce, '\u22bc', '\\barwedge', !0),
      ie(oe, he, ce, '\u22bb', '\\veebar', !0),
      ie(oe, le, ce, '\u2299', '\\odot', !0),
      ie(oe, le, ce, '\u2295', '\\oplus', !0),
      ie(oe, le, ce, '\u2297', '\\otimes', !0),
      ie(oe, le, xe, '\u2202', '\\partial', !0),
      ie(oe, le, ce, '\u2298', '\\oslash', !0),
      ie(oe, he, ce, '\u229a', '\\circledcirc', !0),
      ie(oe, he, ce, '\u22a1', '\\boxdot', !0),
      ie(oe, le, ce, '\u25b3', '\\bigtriangleup'),
      ie(oe, le, ce, '\u25bd', '\\bigtriangledown'),
      ie(oe, le, ce, '\u2020', '\\dagger'),
      ie(oe, le, ce, '\u22c4', '\\diamond'),
      ie(oe, le, ce, '\u22c6', '\\star'),
      ie(oe, le, ce, '\u25c3', '\\triangleleft'),
      ie(oe, le, ce, '\u25b9', '\\triangleright'),
      ie(oe, le, ge, '{', '\\{'),
      ie(se, le, xe, '{', '\\{'),
      ie(se, le, xe, '{', '\\textbraceleft'),
      ie(oe, le, ue, '}', '\\}'),
      ie(se, le, xe, '}', '\\}'),
      ie(se, le, xe, '}', '\\textbraceright'),
      ie(oe, le, ge, '{', '\\lbrace'),
      ie(oe, le, ue, '}', '\\rbrace'),
      ie(oe, le, ge, '[', '\\lbrack', !0),
      ie(se, le, xe, '[', '\\lbrack', !0),
      ie(oe, le, ue, ']', '\\rbrack', !0),
      ie(se, le, xe, ']', '\\rbrack', !0),
      ie(oe, le, ge, '(', '\\lparen', !0),
      ie(oe, le, ue, ')', '\\rparen', !0),
      ie(se, le, xe, '<', '\\textless', !0),
      ie(se, le, xe, '>', '\\textgreater', !0),
      ie(oe, le, ge, '\u230a', '\\lfloor', !0),
      ie(oe, le, ue, '\u230b', '\\rfloor', !0),
      ie(oe, le, ge, '\u2308', '\\lceil', !0),
      ie(oe, le, ue, '\u2309', '\\rceil', !0),
      ie(oe, le, xe, '\\', '\\backslash'),
      ie(oe, le, xe, '\u2223', '|'),
      ie(oe, le, xe, '\u2223', '\\vert'),
      ie(se, le, xe, '|', '\\textbar', !0),
      ie(oe, le, xe, '\u2225', '\\|'),
      ie(oe, le, xe, '\u2225', '\\Vert'),
      ie(se, le, xe, '\u2225', '\\textbardbl'),
      ie(se, le, xe, '~', '\\textasciitilde'),
      ie(se, le, xe, '\\', '\\textbackslash'),
      ie(se, le, xe, '^', '\\textasciicircum'),
      ie(oe, le, be, '\u2191', '\\uparrow', !0),
      ie(oe, le, be, '\u21d1', '\\Uparrow', !0),
      ie(oe, le, be, '\u2193', '\\downarrow', !0),
      ie(oe, le, be, '\u21d3', '\\Downarrow', !0),
      ie(oe, le, be, '\u2195', '\\updownarrow', !0),
      ie(oe, le, be, '\u21d5', '\\Updownarrow', !0),
      ie(oe, le, fe, '\u2210', '\\coprod'),
      ie(oe, le, fe, '\u22c1', '\\bigvee'),
      ie(oe, le, fe, '\u22c0', '\\bigwedge'),
      ie(oe, le, fe, '\u2a04', '\\biguplus'),
      ie(oe, le, fe, '\u22c2', '\\bigcap'),
      ie(oe, le, fe, '\u22c3', '\\bigcup'),
      ie(oe, le, fe, '\u222b', '\\int'),
      ie(oe, le, fe, '\u222b', '\\intop'),
      ...
      ie(oe, le, fe, '\u220f', '\\prod'),
      ie(oe, le, fe, '\u2211', '\\sum'),
      ie(oe, le, fe, '\u2a02', '\\bigotimes'),
      ie(oe, le, fe, '\u2a01', '\\bigoplus'),
      ie(oe, le, fe, '\u2a00', '\\bigodot'),
      ie(oe, le, fe, '\u222e', '\\oint'),
      ie(oe, le, fe, '\u222f', '\\oiint'),
      ie(oe, le, fe, '\u2230', '\\oiiint'),
      ie(oe, le, fe, '\u2a06', '\\bigsqcup'),
      ie(oe, le, fe, '\u222b', '\\smallint'),
      ie(se, le, pe, '\u2026', '\\textellipsis'),
      ie(oe, le, pe, '\u2026', '\\mathellipsis'),
      ie(se, le, pe, '\u2026', '\\ldots', !0),
      ie(oe, le, pe, '\u2026', '\\ldots', !0),
      ie(oe, le, pe, '\u22ef', '\\@cdots', !0),
      ie(oe, le, pe, '\u22f1', '\\ddots', !0),
      ie(oe, le, xe, '\u22ee', '\\varvdots'),
      ie(oe, le, me, '\u02ca', '\\acute'),
      ie(oe, le, me, '\u02cb', '\\grave'),
      ie(oe, le, me, '\xa8', '\\ddot'),
      ie(oe, le, me, '~', '\\tilde'),
      ie(oe, le, me, '\u02c9', '\\bar'),
      ie(oe, le, me, '\u02d8', '\\breve'),
      ie(oe, le, me, '\u02c7', '\\check'),
      ...
      ie(se, le, xe, '\u0131', '\\i', !0),
      ie(se, le, xe, '\u0237', '\\j', !0),
      ie(se, le, xe, '\xdf', '\\ss', !0),
      ie(se, le, xe, '\xe6', '\\ae', !0),
      ie(se, le, xe, '\u0153', '\\oe', !0),
      ie(se, le, xe, '\xf8', '\\o', !0),
      ie(se, le, xe, '\xc6', '\\AE', !0),
      ie(se, le, xe, '\u0152', '\\OE', !0),
      ie(se, le, xe, '\xd8', '\\O', !0),
      ie(se, le, me, '\u02ca', "\\'"),
      ie(se, le, me, '\u02cb', '\\`'),
      ...
      ie(se, le, me, '\xa8', '\\"'),
      ie(se, le, me, '\u02dd', '\\H'),
      ie(se, le, me, '\u25ef', '\\textcircled')
    var we = { '--': !0, '---': !0, '``': !0, "''": !0 }
    ie(se, le, xe, '\u2013', '--', !0),
      ie(se, le, xe, '\u2013', '\\textendash'),
      ie(se, le, xe, '\u2014', '---', !0),
      ie(se, le, xe, '\u2014', '\\textemdash'),
      ie(se, le, xe, '\u2018', '`', !0),
      ie(se, le, xe, '\u2018', '\\textquoteleft'),
      ie(se, le, xe, '\u2019', "'", !0),
      ie(se, le, xe, '\u2019', '\\textquoteright'),
      ie(se, le, xe, '\u201c', '``', !0),
      ie(se, le, xe, '\u201c', '\\textquotedblleft'),
      ie(se, le, xe, '\u201d', "''", !0),
      ie(se, le, xe, '\u201d', '\\textquotedblright'),
      ie(oe, le, xe, '\xb0', '\\degree', !0),
      ie(se, le, xe, '\xb0', '\\degree'),
      ie(se, le, xe, '\xb0', '\\textdegree', !0),
      ie(oe, le, xe, '\xa3', '\\pounds'),
      ie(oe, le, xe, '\xa3', '\\mathsterling', !0),
      ie(se, le, xe, '\xa3', '\\pounds'),
      ie(se, le, xe, '\xa3', '\\textsterling', !0),
      ie(oe, he, xe, '\u2720', '\\maltese'),
      ie(se, he, xe, '\u2720', '\\maltese')
    ...
    for (
      var Be = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz', Ce = 0;
      Ce < Be.length;
      Ce++
    ) {
      var qe = Be.charAt(Ce)
      ie(oe, le, de, qe, qe), ie(se, le, xe, qe, qe)
    }
    ie(oe, he, xe, 'C', '\u2102'),
      ie(se, he, xe, 'C', '\u2102'),
      ie(oe, he, xe, 'H', '\u210d'),
      ...
      ie(oe, le, de, 'h', '\u210e'),
      ie(se, le, de, 'h', '\u210e')
    for (var Ne = '', Ie = 0; Ie < Be.length; Ie++) {
      var Re = Be.charAt(Ie)
      ie(oe, le, de, Re, (Ne = String.fromCharCode(55349, 56320 + Ie))),
        ie(se, le, xe, Re, Ne),
        ie(oe, le, de, Re, (Ne = String.fromCharCode(55349, 56372 + Ie))),
        ie(se, le, xe, Re, Ne),
        ie(oe, le, de, Re, (Ne = String.fromCharCode(55349, 56424 + Ie))),
        ie(se, le, xe, Re, Ne),
        ie(oe, le, de, Re, (Ne = String.fromCharCode(55349, 56580 + Ie))),
        ie(se, le, xe, Re, Ne),
        ie(oe, le, de, Re, (Ne = String.fromCharCode(55349, 56736 + Ie))),
        ie(se, le, xe, Re, Ne),
        ie(oe, le, de, Re, (Ne = String.fromCharCode(55349, 56788 + Ie))),
        ie(se, le, xe, Re, Ne),
        ie(oe, le, de, Re, (Ne = String.fromCharCode(55349, 56840 + Ie))),
        ie(se, le, xe, Re, Ne),
        ie(oe, le, de, Re, (Ne = String.fromCharCode(55349, 56944 + Ie))),
        ie(se, le, xe, Re, Ne),
        Ie < 26 &&
          (ie(oe, le, de, Re, (Ne = String.fromCharCode(55349, 56632 + Ie))),
          ie(se, le, xe, Re, Ne),
          ie(oe, le, de, Re, (Ne = String.fromCharCode(55349, 56476 + Ie))),
          ie(se, le, xe, Re, Ne))
    }
    ie(oe, le, de, 'k', (Ne = String.fromCharCode(55349, 56668))), ie(se, le, xe, 'k', Ne)
    for (var Oe = 0; Oe < 10; Oe++) {
      var He = Oe.toString()
      ie(oe, le, de, He, (Ne = String.fromCharCode(55349, 57294 + Oe))),
        ie(se, le, xe, He, Ne),
        ie(oe, le, de, He, (Ne = String.fromCharCode(55349, 57314 + Oe))),
        ie(se, le, xe, He, Ne),
        ie(oe, le, de, He, (Ne = String.fromCharCode(55349, 57324 + Oe))),
        ie(se, le, xe, He, Ne),
        ie(oe, le, de, He, (Ne = String.fromCharCode(55349, 57334 + Oe))),
        ie(se, le, xe, He, Ne)
    }
    ...
    var Pe = [
      ...
      Ve = function (e, t, r) {
        return (
          ae[r][e] && ae[r][e].replace && (e = ae[r][e].replace), { value: e, metrics: q(e, t, r) }
        )
      },
      Ge = function (e, t, r, n, a) {
        ...
        if (((e = o.value), s)) {
          ...
          ;('text' === r || (n && 'mathit' === n.font)) && (l = 0),
            (i = new Z(e, s.height, s.depth, l, s.skew, s.width, a))
        } else
          'undefined' != typeof console &&
            console.warn(
              "No character metrics for '" + e + "' in style '" + t + "' and mode '" + r + "'"
            ),
            (i = new Z(e, 0, 0, 0, 0, 0, a))
        if (n) {
      ...
      Ue = function (e, t) {
        if (G(e.classes) !== G(t.classes) || e.skew !== t.skew || e.maxFontSize !== t.maxFontSize)
          return !1
        ...
        mathsym: function (e, t, r, n) {
          return (
            ...
            'boldsymbol' === r.font && Ve(e, 'Main-Bold', t).metrics
              ? Ge(e, 'Main-Bold', t, r, n.concat(['mathbf']))
              : '\\' === e || 'main' === ae[t][e].font
              ? Ge(e, 'Main-Regular', t, r, n)
              : Ge(e, 'AMS-Regular', t, r, n.concat(['amsrm']))
          )
        },
        makeSpan: Xe,
        makeSvgSpan: We,
          ...
          for (
            var r = (function (e) {
                if ('individualShift' === e.positionType) {
                  for (
                    var t = e.children, r = [t[0]], n = -t[0].shift - t[0].elem.depth, a = n, i = 1;
                    i < t.length;
                    i++
                  ) {
        ...
        makeOrd: function (e, t, r) {
          ...
          if (l) {
            ...
            if ('boldsymbol' === l) {
              ...
              s
                ? ((u = $e[l].fontName), (p = [l]))
                : ((u = je(l, t.fontWeight, t.fontShape)), (p = [l, t.fontWeight, t.fontShape]))
            if (Ve(i, u, a).metrics) return Ge(i, u, a, t, o.concat(p))
            if (we.hasOwnProperty(i) && 'Typewriter' === u.substr(0, 10)) {
      ...
      et = { number: 5, unit: 'mu' },
      tt = {
        mord: { mop: Je, mbin: Qe, mrel: et, minner: Je },
        mop: { mord: Je, mop: Je, mrel: et, minner: Je },
        mbin: { mord: Qe, mop: Qe, mopen: Qe, minner: Qe },
        mrel: { mord: et, mop: et, mopen: et, minner: et },
        mopen: {},
        mclose: { mop: Je, mbin: Qe, mrel: et, minner: Je },
        mpunct: { mord: Je, mop: Je, mrel: et, mopen: Je, mclose: Je, mpunct: Je, minner: Je },
        minner: { mord: Je, mop: Je, mbin: Qe, mrel: et, mopen: Je, mpunct: Je, minner: Je }
      },
      rt = {
        mord: { mop: Je },
        mop: { mord: Je, mop: Je },
    ...
    var lt = function (e) {
      ...
      mt = Ke.makeSpan,
      ct = ['leftmost', 'mbin', 'mopen', 'mrel', 'mop', 'mpunct'],
      ut = ['rightmost', 'mrel', 'mclose', 'mpunct'],
      pt = { display: x.DISPLAY, text: x.TEXT, script: x.SCRIPT, scriptscript: x.SCRIPTSCRIPT },
      dt = {
        mord: 'mord',
        mop: 'mop',
        mbin: 'mbin',
      ...
      ft = function (e, t, r, n) {
        ...
        if (1 === e.length) {
          ...
          'sizing' === m.type
            ...
            : 'styling' === m.type && (h = t.havingStyle(pt[m.style]))
        }
        var c = mt([n[0] || 'leftmost'], [], t),
          u = mt([n[1] || 'rightmost'], [], t),
          p = 'root' === r
        return (
          gt(
            a,
            function (e, t) {
              var r = t.classes[0],
                n = e.classes[0]
              'mbin' === r && l.contains(ut, n)
                ? (t.classes[0] = 'mord')
                : 'mbin' === n && l.contains(ct, r) && (e.classes[0] = 'mord')
            },
            { node: c },
            u,
            p
      ...
      gt = function e(t, r, n, a, i) {
        ...
        for (var o = 0; o < t.length; o++) {
          ...
          if (l) e(l.children, r, n, null, i)
            ...
            h ? (n.node = s) : i && s.hasClass('newline') && (n.node = mt(['leftmost'])),
      ...
      vt = function (e) {
        return e instanceof A || e instanceof _ || (e instanceof W && e.hasClass('enclosing'))
          ? e
          : null
      },
      bt = function e(t, r) {
    ...
    function kt(e, t) {
      var r = mt(['base'], e, t),
        n = mt(['strut'])
      return (
        (n.style.height = V(r.height + r.depth)),
    ...
    function St(e, t) {
      ...
      for (var i, o = [], s = [], l = 0; l < a.length; l++)
        if (
          ...
          for (
            var h = !1;
            l < a.length - 1 && a[l + 1].hasClass('mspace') && !a[l + 1].hasClass('newline');

          )
            l++, s.push(a[l]), a[l].hasClass('nobreak') && (h = !0)
          h || (o.push(kt(s, t)), (s = []))
        } else
          a[l].hasClass('newline') &&
            (s.pop(), s.length > 0 && (o.push(kt(s, t)), (s = [])), o.push(a[l]))
      s.length > 0 && o.push(kt(s, t)),
        r ? (((i = kt(ft(r, t, !0))).classes = ['tag']), o.push(i)) : n && o.push(n)
      var m = mt(['katex-html'], o)
    ...
    var zt = (function () {
        ...
        return (
          ...
          (t.toMarkup = function () {
            ...
            for (var t in this.attributes)
              Object.prototype.hasOwnProperty.call(this.attributes, t) &&
                ((e += ' ' + t + '="'), (e += l.escape(this.attributes[t])), (e += '"'))
            this.classes.length > 0 && (e += ' class ="' + l.escape(G(this.classes)) + '"'),
              (e += '>')
            for (var r = 0; r < this.children.length; r++) e += this.children[r].toMarkup()
            return (e += '</' + this.type + '>')
          }),
      ...
      qt = function (e, t) {
        ...
        var a = e.text
        return l.contains(['\\imath', '\\jmath'], a)
          ? null
          : (ae[n][a] && ae[n][a].replace && (a = ae[n][a].replace),
            q(a, Ke.fontMap[r].fontName, n) ? Ke.fontMap[r].variant : null)
      },
      Nt = function (e, t, r) {
        if (1 === e.length) {
          var n = Rt(e[0], t)
    ...
    function Ot(e, t, r, n, a) {
      var i,
        o = Nt(e, r)
      i =
        1 === o.length && o[0] instanceof zt && l.contains(['mrow', 'mtable'], o[0].type)
          ? o[0]
          : new Tt.MathNode('mrow', o)
    ...
    var Ht = function (e) {
      ...
      Ft = function (e, t, r, n, a) {
        ...
        if (/fbox|color|angl/.test(t)) {
          ...
          var l = []
          ;/^[bx]cancel$/.test(t) &&
            l.push(new Q({ x1: '0', y1: '0', x2: '100%', y2: '100%', 'stroke-width': '0.046em' })),
            /^x?cancel$/.test(t) &&
              l.push(new Q({ x1: '0', y1: '100%', x2: '100%', y2: '0', 'stroke-width': '0.046em' }))
          var h = new K(l, { width: '100%', height: V(o) })
          i = Ke.makeSvgSpan([], [h], a)
        }
        return (i.height = o), (i.style.height = V(o)), i
      },
      Vt = function (e) {
        var t = new Tt.MathNode('mo', [new Tt.TextNode(Dt[e.replace(/^\\/, '')])])
      ...
      Gt = function (e, t) {
        var r = (function () {
            ...
            if (l.contains(['widehat', 'widecheck', 'widetilde', 'utilde'], n)) {
              ...
              return { span: Ke.makeSvgSpan([], [c], t), minWidth: 0, height: o }
            }
            var u,
              p,
              d,
            ...
            if (1 === w) (u = ['hide-tail']), (p = [g[3]])
              ...
              (u = ['halfarrow-left', 'halfarrow-right']), (p = ['xMinYMin', 'xMaxYMin'])
            else {
              if (3 !== w)
                throw new Error(
            ...
            for (var k = 0; k < w; k++) {
              ...
              ;(z.style.height = V(x)), f.push(z)
            }
            return { span: Ke.makeSpan(['stretchy'], f, t), minWidth: b, height: x }
          })(),
          n = r.span,
          a = r.minWidth,
          i = r.height
        return (n.height = i), (n.style.height = V(i)), a > 0 && (n.style.minWidth = V(a)), n
      }
    function Ut(e, t) {
      if (!e || e.type !== t)
        throw new Error(
    ...
    var Wt = function (e, t) {
        ...
        if (n.isStretchy)
            ...
            (h = Ke.makeVList(
              {
                ...
                children: [
                  { type: 'elem', elem: i },
                  {
                    ...
                    wrapperStyle:
                      o > 0
                        ? { width: 'calc(100% - ' + V(2 * o) + ')', marginLeft: V(2 * o) }
                        : void 0
                  }
                ]
              },
          ...
          var u, p
          '\\vec' === n.label
            ? ((u = Ke.staticSvg('vec', t)), (p = Ke.svgData.vec[1]))
            : (((u = ee(
                (u = Ke.makeOrd({ mode: n.mode, text: n.label }, t, 'textord'))
              )).italic = 0),
              (p = u.width),
              m && (c += u.depth)),
            (h = Ke.makeSpan(['accent-body'], [u]))
      ...
      _t = function (e, t) {
        var r = e.isStretchy ? Vt(e.label) : new Tt.MathNode('mo', [Bt(e.label, e.mode)]),
        ...
        handler: function (e, t) {
          ...
          return (
            'math' === n &&
              ...
              (n = 'text')),
            { type: 'accent', mode: n, label: e.funcName, isStretchy: !1, isShifty: !0, base: r }
          )
        },
        htmlBuilder: Wt,
        mathmlBuilder: _t
      ...
      htmlBuilder: function (e, t) {
        ...
        i.classes.push(o + '-arrow-pad'),
          e.below &&
            ...
            (r = Ke.wrapFragment(wt(e.below, a, t), t)).classes.push(o + '-arrow-pad'))
        var s,
          l = Gt(e, t),
    ...
    ot({
      ...
      mathmlBuilder: function (e, t) {
        ...
        return (
          ...
          (r = new Tt.MathNode('mstyle', [r])).setAttribute('displaystyle', 'false'),
    ...
    ot({
      ...
      handler: function (e, t) {
        var r = e.parser,
          ...
          a = t[1]
        return { type: 'color', mode: r.mode, color: n, body: ht(a) }
      },
      htmlBuilder: Qt,
      mathmlBuilder: er
    }),
      ...
      ot({
        ...
        htmlBuilder: function (e, t) {
          ...
          return (
            e.newLine &&
              (r.classes.push('newline'), e.size && (r.style.marginTop = V(F(e.size, t)))),
            r
          )
        },
        mathmlBuilder: function (e, t) {
          ...
          return (
            e.newLine &&
              ...
              e.size && r.setAttribute('height', V(F(e.size, t)))),
            r
          )
        }
      })
    var tr = {
      ...
      nr = function (e, t, r, n) {
        ...
        null == a &&
          ((r.noexpand = !0),
          (a = { tokens: [r], numArgs: 0, unexpandable: !e.gullet.isExpandable(r.text) })),
    ...
    ot({
      ...
      handler: function (e) {
        ...
        if (tr[a.text])
          return (
            ('\\global' !== r && '\\\\globallong' !== r) || (a.text = tr[a.text]),
      ...
      ot({
        ...
        handler: function (e) {
          ...
          return (
            ...
            t.gullet.macros.set(i, { tokens: h, numArgs: s, delimiters: l }, r === tr[r]),
      ...
      ot({
        ...
        handler: function (e) {
          var t = e.parser,
            r = e.funcName,
            n = rr(t.gullet.popToken())
          t.gullet.consumeSpaces()
          var a = (function (e) {
            var t = e.gullet.popToken()
            return (
              '=' === t.text && ' ' === (t = e.gullet.popToken()).text && (t = e.gullet.popToken()),
              t
            )
          })(t)
          return nr(t, n, a, '\\\\globallet' === r), { type: 'internal', mode: t.mode }
        }
      }),
      ot({
        type: 'internal',
    ...
    var ar = function (e, t, r) {
        var n = q((ae.math[e] && ae.math[e].replace) || e, t, r)
      ...
      or = function (e, t, r) {
        ...
        e.classes.push('delimcenter'), (e.style.top = V(a)), (e.height -= a), (e.depth += a)
      },
      sr = function (e, t, r, n, a, i) {
        var o = (function (e, t, r, n) {
            return Ke.makeSymbol(e, 'Size' + t + '-Regular', r, n)
          })(e, t, a, n),
          s = ir(Ke.makeSpan(['delimsizing', 'size' + t], [o], n), x.TEXT, n, i)
        return r && or(s, n, x.TEXT), s
      },
      lr = function (e, t, r) {
        var n
        return (
      ...
      hr = function (e, t, r) {
        var n = T['Size4-Regular'][e.charCodeAt(0)]
            ? T['Size4-Regular'][e.charCodeAt(0)][4]
            : T['Size1-Regular'][e.charCodeAt(0)][4],
          a = new J(
            'inner',
            (function (e, t) {
              switch (e) {
        ...
        return (
          (o.height = t), (o.style.height = V(t)), (o.style.width = V(n)), { type: 'elem', elem: o }
        )
      },
      mr = { type: 'kern', size: -0.008 },
      cr = ['|', '\\lvert', '\\rvert', '\\vert'],
      ur = ['\\|', '\\lVert', '\\rVert', '\\Vert'],
      pr = function (e, t, r, n, a, i) {
        var o, s, h, m
        ;(o = h = m = e), (s = null)
        var c = 'Size1-Regular'
        '\\uparrow' === e
          ...
          ? (h = '\u2225')
          : '[' === e || '\\lbrack' === e
          ? ((o = '\u23a1'), (h = '\u23a2'), (m = '\u23a3'), (c = 'Size4-Regular'))
          : ']' === e || '\\rbrack' === e
          ? ((o = '\u23a4'), (h = '\u23a5'), (m = '\u23a6'), (c = 'Size4-Regular'))
          : '\\lfloor' === e || '\u230a' === e
          ? ((h = o = '\u23a2'), (m = '\u23a3'), (c = 'Size4-Regular'))
          : '\\lceil' === e || '\u2308' === e
          ? ((o = '\u23a1'), (h = m = '\u23a2'), (c = 'Size4-Regular'))
          : '\\rfloor' === e || '\u230b' === e
          ? ((h = o = '\u23a5'), (m = '\u23a6'), (c = 'Size4-Regular'))
          ...
          ? ((o = '\u239e'), (h = '\u239f'), (m = '\u23a0'), (c = 'Size4-Regular'))
          : '\\{' === e || '\\lbrace' === e
          ? ((o = '\u23a7'), (s = '\u23a8'), (m = '\u23a9'), (h = '\u23aa'), (c = 'Size4-Regular'))
          : '\\}' === e || '\\rbrace' === e
          ? ((o = '\u23ab'), (s = '\u23ac'), (m = '\u23ad'), (h = '\u23aa'), (c = 'Size4-Regular'))
          : '\\lgroup' === e || '\u27ee' === e
          ? ((o = '\u23a7'), (m = '\u23a9'), (h = '\u23aa'), (c = 'Size4-Regular'))
          : '\\rgroup' === e || '\u27ef' === e
          ? ((o = '\u23ab'), (m = '\u23ad'), (h = '\u23aa'), (c = 'Size4-Regular'))
          : '\\lmoustache' === e || '\u23b0' === e
          ? ((o = '\u23a7'), (m = '\u23ad'), (h = '\u23aa'), (c = 'Size4-Regular'))
        ...
        if (null !== s) {
          var w = ar(s, c, a)
          ;(b = w.height + w.depth), (y = 2)
        }
        var k = p + v + b,
          S = k + Math.max(0, Math.ceil((t - k) / (y * f))) * y * f,
          M = n.fontMetrics().axisHeight
        r && (M *= n.sizeMultiplier)
        var z = S / 2 - M,
          A = []
        if ((A.push(lr(m, c, a)), A.push(mr), null === s)) {
          var T = S - p - v + 0.016
          A.push(hr(h, T, n))
        } else {
          var B = (S - p - v - b) / 2 + 0.016
          A.push(hr(h, B, n)), A.push(mr), A.push(lr(s, c, a)), A.push(mr), A.push(hr(h, B, n))
        }
        A.push(mr), A.push(lr(o, c, a))
        var C = n.havingBaseStyle(x.TEXT),
          q = Ke.makeVList({ positionType: 'bottom', positionData: z, children: A }, C)
        return ir(Ke.makeSpan(['delimsizing', 'mult'], [q], C), x.TEXT, n, i)
      },
      dr = 0.08,
      fr = function (e, t, r, n, a) {
      ...
      br = ['<', '>', '\\langle', '\\rangle', '/', '\\backslash', '\\lt', '\\gt'],
      yr = [0, 1.2, 1.8, 2.4, 3],
      xr = [
        { type: 'small', style: x.SCRIPTSCRIPT },
        { type: 'small', style: x.SCRIPT },
        { type: 'small', style: x.TEXT },
        { type: 'large', size: 1 },
        { type: 'large', size: 2 },
        { type: 'large', size: 3 },
        { type: 'large', size: 4 }
      ...
      Mr = function (e, t, r, n) {
        for (var a = Math.min(2, 3 - n.style.size); a < r.length && 'stack' !== r[a].type; a++) {
          var i = ar(e, Sr(r[a]), 'math'),
            o = i.height + i.depth
          if (('small' === r[a].type && (o *= n.havingBaseStyle(r[a].style).sizeMultiplier), o > t))
            return r[a]
        }
        return r[r.length - 1]
      },
      zr = function (e, t, r, n, a, i) {
        ...
        '<' === e || '\\lt' === e || '\u27e8' === e
          ? (e = '\\langle')
          : ('>' !== e && '\\gt' !== e && '\u27e9' !== e) || (e = '\\rangle'),
          (o = l.contains(br, e) ? xr : l.contains(gr, e) ? kr : wr)
        var s = Mr(e, t, o, n)
        return 'small' === s.type
      ...
      Ar = {
        sqrtImage: function (e, t) {
          var r,
            ...
            i = Mr('\\surd', e * a.sizeMultiplier, kr, a),
            o = a.sizeMultiplier,
          ...
          return (
            'small' === i.type
              ...
              ? ((m = 1080 * yr[i.size]),
                (h = (yr[i.size] + s) / o),
                (l = (yr[i.size] + s + dr) / o),
                ((r = fr('sqrtSize' + i.size, l, m, s, t)).style.minWidth = '1.02em'),
                (n = 1 / o))
              : ((l = e + s + dr),
                (h = e + s),
                (m = Math.floor(1e3 * e + s) + 80),
                ((r = fr('sqrtTall', l, m, s, t)).style.minWidth = '0.742em'),
                (n = 1.056)),
            (r.height = h),
            (r.style.height = V(l)),
            { span: r, advanceWidth: n, ruleWidth: (t.fontMetrics().sqrtRuleThickness + s) * o }
          )
        },
        sizedDelim: function (e, t, r, a, i) {
          if (
            ('<' === e || '\\lt' === e || '\u27e8' === e
              ? (e = '\\langle')
              : ('>' !== e && '\\gt' !== e && '\u27e9' !== e) || (e = '\\rangle'),
            l.contains(gr, e) || l.contains(br, e))
          )
            return sr(e, t, !1, r, a, i)
          if (l.contains(vr, e)) return pr(e, yr[t], !1, r, a, i)
    ...
    ot({
      ...
      htmlBuilder: function (e, t) {
        return '.' === e.delim
          ? Ke.makeSpan([e.mclass])
          : Ar.sizedDelim(e.delim, e.size, t, e.mode, [e.mclass])
      },
      mathmlBuilder: function (e) {
        ...
        var n = V(Ar.sizeToMaxHeight[e.size])
      ...
      ot({
        ...
        handler: function (e, t) {
          ...
          return { type: 'leftright-right', mode: e.parser.mode, delim: Cr(t[0], e).text, color: r }
        }
      }),
      ot({
        type: 'leftright',
        ...
        htmlBuilder: function (e, t) {
          qr(e)
          for (
            var r, n, a = ft(e.body, t, !0, ['mopen', 'mclose']), i = 0, o = 0, s = !1, l = 0;
            l < a.length;
            l++
          )
            a[l].isMiddle
              ? (s = !0)
              : ((i = Math.max(a[l].height, i)), (o = Math.max(a[l].depth, o)))
          if (
            ((i *= t.sizeMultiplier),
            (o *= t.sizeMultiplier),
            (r =
              '.' === e.left
                ? xt(t, ['mopen'])
                : Ar.leftRightDelim(e.left, i, o, t, e.mode, ['mopen'])),
            a.unshift(r),
            s)
          )
            for (var h = 1; h < a.length; h++) {
              var m = a[h].isMiddle
              m && (a[h] = Ar.leftRightDelim(m.delim, i, o, m.options, e.mode, []))
            }
          if ('.' === e.right) n = xt(t, ['mclose'])
          else {
            var c = e.rightColor ? t.withColor(e.rightColor) : t
            n = Ar.leftRightDelim(e.right, i, o, c, e.mode, ['mclose'])
          }
      ...
      ot({
        ...
        htmlBuilder: function (e, t) {
          ...
          if ('.' === e.delim) r = xt(t, [])
            ...
            r = Ar.sizedDelim(e.delim, 1, t, e.mode, [])
    ...
    var Nr = function (e, t) {
        ...
        if ('sout' === o)
          ...
          ;((r = Ke.makeSvgSpan(['hide-tail'], [g], t)).style.height = V(p)), (h = i.depth + c + u)
        } else {
          ;/cancel/.test(o)
        ...
        return (
          ...
          /cancel/.test(o) && !m
            ? Ke.makeSpan(['mord', 'cancel-lap'], [a], t)
            : Ke.makeSpan(['mord'], [a], t)
        )
      },
      Ir = function (e, t) {
        var r = 0,
          n = new Tt.MathNode(e.label.indexOf('colorbox') > -1 ? 'mpadded' : 'menclose', [
            Rt(e.body, t)
          ])
        switch (e.label) {
          case '\\cancel':
      ...
      Dr = (function () {
        ...
        return (
          (e.prototype.range = function (t, r) {
            return new e(r, Lr.range(this, t))
          }),
          e
        )
      })()
    ...
    var Yr = function (e, t) {
        ...
        e.colSeparationType &&
          ...
          (p = (t.havingStyle(x.SCRIPT).sizeMultiplier / t.sizeMultiplier) * 0.2778)
        var d = 'CD' === e.colSeparationType ? F({ number: 3, unit: 'ex' }, t) : 12 * u,
          f = 3 * u,
          g = e.arraystretch * d,
          v = 0.7 * g,
          b = 0.3 * g,
        ...
        function w(e) {
          for (var t = 0; t < e.length; ++t)
            t > 0 && (y += 0.25), m.push({ pos: y, isDashed: e[t] })
        }
        ...
        if (
          ...
          for (r = 0; r < i; ++r) {
            ...
            ;((D =
              !0 === L
                ? Ke.makeSpan(['eqn-num'], [], t)
                : !1 === L
                ? Ke.makeSpan([], [], t)
                : Ke.makeSpan([], ft(L, t, !0), t)).depth = H.depth),
              (D.height = H.height),
              O.push({ type: 'elem', elem: D, shift: E })
          }
        for (a = 0, q = 0; a < s || q < I.length; ++a, ++q) {
          for (var P = I[q] || {}, G = !0; 'separator' === P.type; ) {
            if (
              (G ||
                (((C = Ke.makeSpan(['arraycolsep'], [])).style.width = V(
            ...
            var U = '|' === P.separator ? 'solid' : 'dashed',
            ...
            var X = y - N
            X && (Y.style.verticalAlign = V(-X)), R.push(Y), (P = I[++q] || {}), (G = !1)
          }
          if (!(a >= s)) {
            var W = void 0
            ;(a > 0 || e.hskipBeforeAndAfter) &&
              0 !== (W = l.deflt(P.pregap, p)) &&
              (((C = Ke.makeSpan(['arraycolsep'], [])).style.width = V(W)), R.push(C))
            var _ = []
            for (r = 0; r < i; ++r) {
              var j = h[r],
                $ = j[a]
            ...
            ;(_ = Ke.makeVList({ positionType: 'individualShift', children: _ }, t)),
              (_ = Ke.makeSpan(['col-align-' + (P.align || 'c')], [_])),
              R.push(_),
              (a < s - 1 || e.hskipBeforeAndAfter) &&
                0 !== (W = l.deflt(P.postgap, p)) &&
                (((C = Ke.makeSpan(['arraycolsep'], [])).style.width = V(W)), R.push(C))
          }
        }
        if (((h = Ke.makeSpan(['mtable'], R)), m.length > 0)) {
          for (
            var K = Ke.makeLineSpan('hline', t, c),
              J = Ke.makeLineSpan('hdashline', t, c),
          ...
          h = Ke.makeVList({ positionType: 'individualShift', children: Q }, t)
        }
        if (0 === O.length) return Ke.makeSpan(['mord'], [h], t)
        var re = Ke.makeVList({ positionType: 'individualShift', children: O }, t)
      ...
      Wr = function (e, t) {
        for (
          var r = [],
            n = new Tt.MathNode('mtd', [], ['mtr-glue']),
            a = new Tt.MathNode('mtd', [], ['mml-eqn-num']),
            i = 0;
          i < e.body.length;
          i++
        ) {
          for (var o = e.body[i], s = [], l = 0; l < o.length; l++)
            s.push(new Tt.MathNode('mtd', [Rt(o[l], t)]))
          e.tags && e.tags[i] && (s.unshift(n), s.push(n), e.leqno ? s.unshift(a) : s.push(a)),
            r.push(new Tt.MathNode('mtr', s))
        }
        ...
        if (e.cols && e.cols.length > 0) {
          var p = e.cols,
            ...
            g = 0,
            v = p.length
          'separator' === p[0].type && ((c += 'top '), (g = 1)),
            'separator' === p[p.length - 1].type && ((c += 'bottom '), (v -= 1))
          for (var b = g; b < v; b++)
            'align' === p[b].type
              ? ((u += Xr[p[b].align]), f && (d += 'none '), (f = !0))
              : 'separator' === p[b].type &&
                f &&
                ((d += '|' === p[b].separator ? 'solid ' : 'dashed '), (f = !1))
        ...
        return (
          ...
          '' !== c && (h = new Tt.MathNode('menclose', [h])).setAttribute('notation', c.trim()),
          e.arraystretch &&
            e.arraystretch < 1 &&
            (h = new Tt.MathNode('mstyle', [h])).setAttribute('scriptlevel', '1'),
          h
        )
      },
      _r = function (e, t) {
        ;-1 === e.envName.indexOf('ed') && Fr(e)
        var r,
          a = [],
        ...
        for (var p = 0; p < l; ++p) {
          var d = 'r',
            f = 0
          p % 2 == 1 ? (d = 'l') : p > 0 && u && (f = 1),
            (a[p] = { type: 'align', align: d, pregap: f, postgap: 0 })
        }
    ...
    Or({
      ...
      handler: function (e, t) {
        ...
        return Gr(e.parser, a, Ur(e.envName))
      },
      htmlBuilder: Yr,
      mathmlBuilder: Wr
    }),
      Or({
        ...
        handler: function (e) {
          ...
          var o = Gr(e.parser, a, Ur(e.envName)),
            s = Math.max.apply(
              Math,
              [0].concat(
      ...
      Or({
        ...
        handler: function (e, t) {
          ...
          if ((a = Gr(e.parser, a, 'script')).body.length > 0 && a.body[0].length > 1)
      ...
      Or({
        ...
        props: { numArgs: 0 },
        handler: function (e) {
          l.contains(['gather', 'gather*'], e.envName) && Fr(e)
          var t = {
            cols: [{ type: 'align', align: 'c' }],
            addJot: !0,
            colSeparationType: 'gather',
            autoTag: Vr(e.envName),
            emptySingleRow: !0,
            leqno: e.parser.settings.leqno
          }
          ...
          return (
            ...
            (function (e) {
              ...
              for (var a, i, o = [], s = [o], l = 0; l < t.length; l++) {
                for (
                  var h = t[l],
                    m = { type: 'styling', body: [], mode: 'math', style: 'display' },
                    c = 0;
                  c < h.length;
                  c++
                )
                  if (Kt(h[c])) {
                    ...
                    if (
                      ...
                      if (!('<>AV'.indexOf(u) > -1))
                        throw new n('Expected one of "<>AV=|." after @', h[c])
                      for (var d = 0; d < 2; d++) {
                        ...
                        if (f)
                          throw new n('Missing a ' + u + ' character to complete a CD arrow.', h[c])
                      }
                    }
                    var v = { type: 'styling', body: [Jt(u, p, e)], mode: 'math', style: 'display' }
    ...
    function Kr(e, t) {
      ...
      return (
        'minner' === e.mclass
          ? (r = new Tt.MathNode('mpadded', n))
          : 'mord' === e.mclass
          ? e.isCharacterBox
            ? ((r = n[0]).type = 'mi')
            : (r = new Tt.MathNode('mi', n))
          : (e.isCharacterBox ? ((r = n[0]).type = 'mo') : (r = new Tt.MathNode('mo', n)),
            'mbin' === e.mclass
    ...
    var rn = function (e, t) {
        ...
        return (
          'display' === e
            ? (r = r.id >= x.SCRIPT.id ? r.text() : x.DISPLAY)
            : 'text' === e && r.size === x.DISPLAY.size
            ? (r = x.TEXT)
            : 'script' === e
            ? (r = x.SCRIPT)
            : 'scriptscript' === e && (r = x.SCRIPTSCRIPT),
          r
        )
      },
      nn = function (e, t) {
        ...
        if (
          (e.hasBarLine
            ? (e.barSize
                ? ((m = F(e.barSize, t)), (h = Ke.makeLineSpan('frac-line', t, m)))
                : (h = Ke.makeLineSpan('frac-line', t)),
              (m = h.height),
              (c = h.height))
            : ((h = null), (m = 0), (c = t.fontMetrics().defaultRuleThickness)),
          n.size === x.DISPLAY.size || 'display' === e.size
            ? ((u = t.fontMetrics().num1),
              (p = m > 0 ? 3 * c : 7 * c),
              (d = t.fontMetrics().denom1))
            : (m > 0
                ? ((u = t.fontMetrics().num2), (p = c))
                : ((u = t.fontMetrics().num3), (p = 3 * c)),
              (d = t.fontMetrics().denom2)),
          h)
        ) {
          var w = t.fontMetrics().axisHeight
          u - o.depth - (w + 0.5 * m) < p && (u += p - (u - o.depth - (w + 0.5 * m))),
            w - 0.5 * m - (y.height - d) < p && (d += p - (w - 0.5 * m - (y.height - d)))
          var k = -(w - 0.5 * m)
          f = Ke.makeVList(
            {
              positionType: 'individualShift',
        ...
        return (
          ...
          (g =
            n.size === x.DISPLAY.size
              ? t.fontMetrics().delim1
              : n.size === x.SCRIPTSCRIPT.size
              ? t.havingStyle(x.SCRIPT).fontMetrics().delim2
              : t.fontMetrics().delim2),
          (v =
            null == e.leftDelim
              ? xt(t, ['mopen'])
              : Ar.customSizedDelim(e.leftDelim, g, !0, t.havingStyle(n), e.mode, ['mopen'])),
          (b = e.continued
            ? Ke.makeSpan([])
            : null == e.rightDelim
            ? xt(t, ['mclose'])
            : Ar.customSizedDelim(e.rightDelim, g, !0, t.havingStyle(n), e.mode, ['mclose'])),
          Ke.makeSpan(['mord'].concat(r.sizingClasses(t)), [v, Ke.makeSpan(['mfrac'], [f]), b], t)
        )
      },
      an = function (e, t) {
    ...
    var ln = function (e, t) {
      ...
      'supsub' === e.type
        ? ((r = e.sup
            ? wt(e.sup, t.havingStyle(a.sup()), t)
            : wt(e.sub, t.havingStyle(a.sub()), t)),
          (n = Ut(e.base, 'horizBrace')))
        : (n = Ut(e, 'horizBrace'))
      var i,
        o = wt(n.base, t.havingBaseStyle(x.DISPLAY)),
        s = Gt(n, t)
      if (
        (n.isOver
          ? (i = Ke.makeVList(
    ...
    ot({
      ...
      ot({
        ...
        handler: function (e, t) {
          ...
          return r.settings.isTrusted({ command: '\\href', url: a })
            ? { type: 'href', mode: r.mode, href: a, body: ht(n) }
      ...
      ot({
        ...
        handler: function (e, t) {
          ...
          return { type: 'href', mode: r.mode, href: n, body: ht(s) }
        }
      }),
      ot({
        type: 'hbox',
        ...
        handler: function (e, t) {
          return { type: 'hbox', mode: e.parser.mode, body: ht(t[0]) }
        },
        htmlBuilder: function (e, t) {
          var r = ft(e.body, t, !1)
          return Ke.makeFragment(r)
        ...
        mathmlBuilder: function (e, t) {
          return new Tt.MathNode('mrow', Nt(e.body, t))
        }
      }),
      ot({
        type: 'html',
        ...
        handler: function (e, t) {
          var r,
            ...
            s = t[1]
          a.settings.strict &&
            a.settings.reportNonstrict('htmlExtension', 'HTML extension is disabled on strict mode')
          var l = {}
          switch (i) {
            case '\\htmlClass':
          ...
          return a.settings.isTrusted(r)
            ? { type: 'html', mode: a.mode, attributes: l, body: ht(s) }
      ...
      ot({
        ...
        handler: function (e, t) {
          return { type: 'htmlmathml', mode: e.parser.mode, html: ht(t[0]), mathml: ht(t[1]) }
        },
        htmlBuilder: function (e, t) {
          var r = ft(e.html, t, !1)
          return Ke.makeFragment(r)
    ...
    var hn = function (e) {
      ...
      if (!P(r)) throw new n("Invalid unit: '" + r.unit + "' in \\includegraphics.")
      return r
    }
    ot({
      ...
      htmlBuilder: function (e, t) {
        var r = F(e.height, t),
          n = 0
        e.totalheight.number > 0 && (n = F(e.totalheight, t) - r)
        var a = 0
        e.width.number > 0 && (a = F(e.width, t))
        var i = { height: V(r + n) }
      ...
      mathmlBuilder: function (e, t) {
        ...
        if (
          (e.totalheight.number > 0 &&
            ((a = F(e.totalheight, t) - n), r.setAttribute('valign', V(-a))),
          r.setAttribute('height', V(n + a)),
          e.width.number > 0)
        ) {
          var i = F(e.width, t)
      ...
      ot({
        ...
        htmlBuilder: function (e, t) {
          var r
          'clap' === e.alignment
            ? ((r = Ke.makeSpan([], [wt(e.body, t)])), (r = Ke.makeSpan(['inner'], [r], t)))
            : (r = Ke.makeSpan(['inner'], [wt(e.body, t)]))
          var n = Ke.makeSpan(['fix'], []),
            a = Ke.makeSpan([e.alignment], [r, n], t),
            i = Ke.makeSpan(['strut'])
          return (
            (i.style.height = V(a.height + a.depth)),
            a.depth && (i.style.verticalAlign = V(-a.depth)),
            a.children.unshift(i),
            (a = Ke.makeSpan(['thinbox'], [a], t)),
            Ke.makeSpan(['mord', 'vbox'], [a], t)
          )
        },
        mathmlBuilder: function (e, t) {
      ...
      ot({
        ...
        handler: function (e, t) {
          ...
          return (
            n.expect(i), n.switchMode(a), { type: 'styling', mode: n.mode, style: 'text', body: o }
          )
        }
      }),
      ot({
    ...
    var cn = function (e, t, r, n, a, i, o) {
        ...
        if (h && s) {
          var d =
            n.fontMetrics().bigOpSpacing5 + s.elem.height + s.elem.depth + s.kern + e.depth + o
          m = Ke.makeVList(
            {
              positionType: 'bottom',
              positionData: d,
              children: [
                ...
                { type: 'elem', elem: s.elem, marginLeft: V(-i) },
      ...
      pn = function (e, t) {
        var r,
          ...
          i = !1
        'supsub' === e.type
          ? ((r = e.sup), (n = e.sub), (a = Ut(e.base, 'op')), (i = !0))
          : (a = Ut(e, 'op'))
        var o,
          s = t.style,
          h = !1
        if (
          (s.size === x.DISPLAY.size && a.symbol && !l.contains(un, a.name) && (h = !0), a.symbol)
        ) {
          var m = h ? 'Size2-Regular' : 'Size1-Regular',
            c = ''
          if (
            (('\\oiint' !== a.name && '\\oiiint' !== a.name) ||
              ((c = a.name.substr(1)), (a.name = 'oiint' === c ? '\\iint' : '\\iiint')),
            (o = Ke.makeSymbol(a.name, m, 'math', t, [
              'mop',
              'op-symbol',
              h ? 'large-op' : 'small-op'
            ])),
          ...
          var d = ft(a.body, t, !0)
          1 === d.length && d[0] instanceof Z
            ? ((o = d[0]).classes[0] = 'mop')
            : (o = Ke.makeSpan(['mop'], d, t))
        } else {
        ...
        var v = 0,
          b = 0
        return (
          (o instanceof Z || '\\oiint' === a.name || '\\oiiint' === a.name) &&
            !a.suppressBaseShift &&
      ...
      dn = function (e, t) {
        var r
        if (e.symbol)
          (r = new zt('mo', [Bt(e.name, e.mode)])),
            l.contains(un, e.name) && r.setAttribute('largeop', 'false')
        else if (e.body) r = new zt('mo', Nt(e.body, t))
        else {
    ...
    ot({
      ...
      ot({
        ...
        handler: function (e) {
          ...
          return (
            1 === r.length && (r = gn[r]),
            { type: 'op', mode: t.mode, limits: !1, parentIsSupSub: !1, symbol: !0, name: r }
          )
        },
        htmlBuilder: pn,
        mathmlBuilder: dn
    ...
    var vn = function (e, t) {
      ...
      if (
        ('supsub' === e.type
          ? ((r = e.sup), (n = e.sub), (a = Ut(e.base, 'operatorname')), (o = !0))
          : (a = Ut(e, 'operatorname')),
        a.body.length > 0)
      ) {
        for (
          var s = a.body.map(function (e) {
            ...
            l = ft(s, t.withFont('mathrm'), !0),
            h = 0;
          h < l.length;
          h++
        ) {
          var m = l[h]
          m instanceof Z && (m.text = m.text.replace(/\u2212/, '-').replace(/\u2217/, '*'))
        }
    ...
    function bn(e, t, r) {
      for (
        var n = ft(e, t, !1), a = t.sizeMultiplier / r.sizeMultiplier, i = 0;
        i < n.length;
        i++
      ) {
    ...
    ot({
      ...
      htmlBuilder: vn,
      mathmlBuilder: function (e, t) {
        for (var r = Nt(e.body, t.withFont('mathrm')), n = !0, a = 0; a < r.length; a++) {
          var i = r[a]
          if (i instanceof Tt.SpaceNode);
            ...
            switch (i.type) {
              ...
              case 'mo':
                var o = i.children[0]
                1 === i.children.length && o instanceof Tt.TextNode
      ...
      Er('\\operatorname', '\\@ifstar\\operatornamewithlimits\\operatorname@'),
      st({
        type: 'ordgroup',
        htmlBuilder: function (e, t) {
          return e.semisimple
            ? Ke.makeFragment(ft(e.body, t, !1))
            : Ke.makeSpan(['mord'], ft(e.body, t, !0), t)
        },
        mathmlBuilder: function (e, t) {
      ...
      ot({
        ...
        handler: function (e, t) {
          var r = e.parser,
            n = t[0]
          return { type: 'phantom', mode: r.mode, body: ht(n) }
        },
        htmlBuilder: function (e, t) {
      ...
      ot({
        ...
        htmlBuilder: function (e, t) {
          ...
          return (
            ...
            Ke.makeSpan(['mord'], [r], t)
          )
        },
        mathmlBuilder: function (e, t) {
          var r = Nt(ht(e.body), t),
      ...
      ot({
        ...
        htmlBuilder: function (e, t) {
          var r = Ke.makeSpan(['mord', 'rule'], [], t),
            n = F(e.width, t),
            a = F(e.height, t),
            i = e.shift ? F(e.shift, t) : 0
          return (
            (r.style.borderRightWidth = V(n)),
            (r.style.borderTopWidth = V(a)),
            (r.style.bottom = V(i)),
            (r.width = n),
            (r.height = a + i),
            (r.depth = -i),
        ...
        mathmlBuilder: function (e, t) {
          var r = F(e.width, t),
            n = F(e.height, t),
            a = e.shift ? F(e.shift, t) : 0,
            i = (t.color && t.getColor()) || 'black',
            o = new Tt.MathNode('mspace')
          o.setAttribute('mathbackground', i),
            o.setAttribute('width', V(r)),
            o.setAttribute('height', V(n))
          var s = new Tt.MathNode('mpadded', [o])
          return (
            a >= 0
              ? s.setAttribute('height', V(a))
              : (s.setAttribute('height', V(a)), s.setAttribute('depth', V(-a))),
            s.setAttribute('voffset', V(a)),
            s
          )
        }
      })
    ...
    ot({
      ...
      handler: function (e, t) {
        ...
        return { type: 'sizing', mode: a.mode, size: yn.indexOf(n) + 1, body: i }
      },
      htmlBuilder: function (e, t) {
      ...
      ot({
        ...
        htmlBuilder: function (e, t) {
          ...
          if (e.index) {
            var d = t.havingStyle(x.SCRIPTSCRIPT),
              ...
              v = Ke.makeVList(
                { positionType: 'shift', positionData: -g, children: [{ type: 'elem', elem: f }] },
                t
              ),
        ...
        mathmlBuilder: function (e, t) {
          var r = e.body,
            n = e.index
          return n
            ? new Tt.MathNode('mroot', [Rt(r, t), Rt(n, t)])
            : new Tt.MathNode('msqrt', [Rt(r, t)])
        }
      })
    var xn = { display: x.DISPLAY, text: x.TEXT, script: x.SCRIPT, scriptscript: x.SCRIPTSCRIPT }
    ot({
      type: 'styling',
    ...
    var wn = function (e, t) {
      ...
      return r
        ? 'op' === r.type
          ? r.limits && (t.style.size === x.DISPLAY.size || r.alwaysHandleSupSub)
            ? pn
            : null
          : 'operatorname' === r.type
          ? r.alwaysHandleSupSub && (t.style.size === x.DISPLAY.size || r.limits)
            ? vn
            : null
          : 'accent' === r.type
    ...
    st({
      ...
      htmlBuilder: function (e, t) {
        ...
        if (s) {
          ...
          ;(n = wt(s, f, t)),
            d || (u = m.height - (f.fontMetrics().supDrop * f.sizeMultiplier) / t.sizeMultiplier)
        }
        if (h) {
          var g = t.havingStyle(t.style.sub())
          ;(a = wt(h, g, t)),
            d || (p = m.depth + (g.fontMetrics().subDrop * g.sizeMultiplier) / t.sizeMultiplier)
        }
        i = t.style === x.DISPLAY ? c.sup1 : t.style.cramped ? c.sup3 : c.sup2
        var v,
          b = t.sizeMultiplier,
          y = V(0.5 / c.ptPerEm / b),
          w = null
        if (a) {
          ...
          ;(m instanceof Z || k) && (w = V(-m.italic))
        }
        if (n && a) {
          ;(u = Math.max(u, i, n.depth + 0.25 * c.xHeight)), (p = Math.max(p, c.sub2))
          var S = 4 * c.defaultRuleThickness
          if (u - n.depth - (a.height - p) < S) {
            p = S - (u - n.depth) + a.height
            var M = 0.8 * c.xHeight - (u - n.depth)
            M > 0 && ((u += M), (p -= M))
          }
          var z = [
            { type: 'elem', elem: a, shift: p, marginRight: y, marginLeft: w },
            { type: 'elem', elem: n, shift: -u, marginRight: y }
          ]
          v = Ke.makeVList({ positionType: 'individualShift', children: z }, t)
        } else if (a) {
          p = Math.max(p, c.sub1, a.height - 0.8 * c.xHeight)
          var A = [{ type: 'elem', elem: a, marginLeft: w, marginRight: y }]
          v = Ke.makeVList({ positionType: 'shift', positionData: p, children: A }, t)
        } else {
          if (!n) throw new Error('supsub must have either sup or sub.')
          ;(u = Math.max(u, i, n.depth + 0.25 * c.xHeight)),
            (v = Ke.makeVList(
              {
                positionType: 'shift',
                positionData: -u,
        ...
        var T = yt(m, 'right') || 'mord'
        return Ke.makeSpan([T], [m, Ke.makeSpan(['msupsub'], [v])], t)
      },
      mathmlBuilder: function (e, t) {
        var r,
          n = !1
        ...
        var a,
          i = [Rt(e.base, t)]
        if ((e.sub && i.push(Rt(e.sub, t)), e.sup && i.push(Rt(e.sup, t)), n))
          a = r ? 'mover' : 'munder'
        else if (e.sub)
          if (e.sup) {
            var o = e.base
            a =
              (o && 'op' === o.type && o.limits && t.style === x.DISPLAY) ||
              (o &&
                'operatorname' === o.type &&
                o.alwaysHandleSupSub &&
                (t.style === x.DISPLAY || o.limits))
                ? 'munderover'
                : 'msubsup'
          } else {
            var s = e.base
            a =
              (s &&
                'op' === s.type &&
                s.limits &&
                (t.style === x.DISPLAY || s.alwaysHandleSupSub)) ||
              (s &&
                'operatorname' === s.type &&
          ...
          var l = e.base
          a =
            (l && 'op' === l.type && l.limits && (t.style === x.DISPLAY || l.alwaysHandleSupSub)) ||
            (l &&
              'operatorname' === l.type &&
              l.alwaysHandleSupSub &&
              (l.limits || t.style === x.DISPLAY))
              ? 'mover'
              : 'msup'
        }
    ...
    var kn = { mi: 'italic', mn: 'normal', mtext: 'normal' }
    st({
      type: 'mathord',
      htmlBuilder: function (e, t) {
      ...
      mathmlBuilder: function (e, t) {
        var r = new Tt.MathNode('mi', [Bt(e.text, e.mode, t)]),
          n = qt(e, t) || 'italic'
        return n !== kn[r.type] && r.setAttribute('mathvariant', n), r
      }
    }),
      st({
        type: 'textord',
        ...
        mathmlBuilder: function (e, t) {
          var r,
            n = Bt(e.text, e.mode, t),
            a = qt(e, t) || 'normal'
          return (
            (r =
              'text' === e.mode
                ? new Tt.MathNode('mtext', [n])
                : /[0-9]/.test(e.text)
                ? new Tt.MathNode('mn', [n])
                : '\\prime' === e.text
                ? new Tt.MathNode('mo', [n])
                : new Tt.MathNode('mi', [n])),
            a !== kn[r.type] && r.setAttribute('mathvariant', a),
            r
          )
        }
      })
    ...
    st({
      ...
      htmlBuilder: function (e, t) {
        ...
        if (Sn.hasOwnProperty(e.text)) return Ke.makeSpan(['mspace', Sn[e.text]], [], t)
        throw new n('Unknown type of space "' + e.text + '"')
      },
      mathmlBuilder: function (e, t) {
        if (!Mn.hasOwnProperty(e.text)) {
          if (Sn.hasOwnProperty(e.text)) return new Tt.MathNode('mspace')
          throw new n('Unknown type of space "' + e.text + '"')
        }
    ...
    st({
      ...
      mathmlBuilder: function (e, t) {
        var r = new Tt.MathNode('mtable', [
          new Tt.MathNode('mtr', [
            zn(),
            new Tt.MathNode('mtd', [It(e.body, t)]),
            zn(),
            new Tt.MathNode('mtd', [It(e.tag, t)])
          ])
        ])
    ...
    var An = {
      ...
      Tn = { '\\textbf': 'textbf', '\\textmd': 'textmd' },
      Bn = { '\\textit': 'textit', '\\textup': 'textup' },
      Cn = function (e, t) {
        var r = e.font
        return r
          ? An[r]
            ? t.withTextFontFamily(An[r])
            : Tn[r]
            ? t.withTextFontWeight(Tn[r])
    ...
    ot({
      ...
      handler: function (e, t) {
        var r = e.parser,
          n = e.funcName,
          a = t[0]
        return { type: 'text', mode: r.mode, body: ht(a), font: n }
      },
      htmlBuilder: function (e, t) {
        var r = Cn(e, t),
          n = ft(e.body, r, !0)
      ...
      ot({
        ...
        htmlBuilder: function (e, t) {
          for (var r = qn(e), n = [], a = t.havingStyle(t.style.text()), i = 0; i < r.length; i++) {
            var o = r[i]
            '~' === o && (o = '\\textasciitilde'),
              n.push(Ke.makeSymbol(o, 'Typewriter-Regular', e.mode, a, ['mord', 'texttt']))
          }
          return Ke.makeSpan(['mord', 'text'].concat(a.sizingClasses(t)), Ke.tryCombineChars(n), a)
        },
        mathmlBuilder: function (e, t) {
          var r = new Tt.TextNode(qn(e)),
      ...
      Rn = (function () {
        ...
        return (
          ...
          (t.lex = function () {
            ...
            if (t === e.length) return new Dr('EOF', new Lr(this, t, t))
            var r = this.tokenRegex.exec(e)
            if (null === r || r.index !== t)
              throw new n(
                "Unexpected character: '" + e[t] + "'",
                new Dr(e[t], new Lr(this, t, t + 1))
              )
            var a = r[6] || r[3] || (r[2] ? '\\ ' : ' ')
            ...
            return new Dr(a, new Lr(this, t, this.tokenRegex.lastIndex))
          }),
          e
        )
      })(),
    ...
    Er('\\noexpand', function (e) {
      ...
      Er('\\@ifstar', '\\@ifnextchar *{\\@firstoftwo{#1}}'),
      Er('\\TextOrMath', function (e) {
    ...
    Er('\\newcommand', function (e) {
      ...
      Er('\\renewcommand', function (e) {
        return Ln(e, !0, !1)
      }),
      Er('\\providecommand', function (e) {
        return Ln(e, !0, !0)
      }),
      Er('\\message', function (e) {
      ...
      Er('\\aa', '\\r a'),
      Er('\\AA', '\\r A'),
      Er('\\textcopyright', '\\html@mathml{\\textcircled{c}}{\\char`\xa9}'),
      Er('\\copyright', '\\TextOrMath{\\textcopyright}{\\text{\\textcopyright}}'),
      Er('\\textregistered', '\\html@mathml{\\textcircled{\\scriptsize R}}{\\char`\xae}'),
      Er('\u212c', '\\mathscr{B}'),
      Er('\u2130', '\\mathscr{E}'),
      Er('\u2131', '\\mathscr{F}'),
      Er('\u210b', '\\mathscr{H}'),
      ...
      Er('\\Bbbk', '\\Bbb{k}'),
      Er('\xb7', '\\cdotp'),
      Er('\\llap', '\\mathllap{\\textrm{#1}}'),
      Er('\\rlap', '\\mathrlap{\\textrm{#1}}'),
      Er('\\clap', '\\mathclap{\\textrm{#1}}'),
      Er('\\mathstrut', '\\vphantom{(}'),
      Er('\\underbar', '\\underline{\\text{#1}}'),
      ...
      Er('\u2259', '\\html@mathml{\\stackrel{\\tiny\\wedge}{=}}{\\mathrel{\\char`\u2258}}'),
      Er('\u225a', '\\html@mathml{\\stackrel{\\tiny\\vee}{=}}{\\mathrel{\\char`\u225a}}'),
      Er('\u225b', '\\html@mathml{\\stackrel{\\scriptsize\\star}{=}}{\\mathrel{\\char`\u225b}}'),
      Er('\u225d', '\\html@mathml{\\stackrel{\\tiny\\mathrm{def}}{=}}{\\mathrel{\\char`\u225d}}'),
      Er('\u225e', '\\html@mathml{\\stackrel{\\tiny\\mathrm{m}}{=}}{\\mathrel{\\char`\u225e}}'),
      Er('\u225f', '\\html@mathml{\\stackrel{\\tiny?}{=}}{\\mathrel{\\char`\u225f}}'),
      Er('\u27c2', '\\perp'),
      Er('\u203c', '\\mathclose{!\\mkern-0.8mu!}'),
      Er('\u220c', '\\notni'),
      Er('\u231c', '\\ulcorner'),
      Er('\u231d', '\\urcorner'),
      Er('\u231e', '\\llcorner'),
      Er('\u231f', '\\lrcorner'),
      Er('\xa9', '\\copyright'),
      Er('\xae', '\\textregistered'),
      Er('\ufe0f', '\\textregistered'),
      Er('\\ulcorner', '\\html@mathml{\\@ulcorner}{\\mathop{\\char"231c}}'),
      Er('\\urcorner', '\\html@mathml{\\@urcorner}{\\mathop{\\char"231d}}'),
      Er('\\llcorner', '\\html@mathml{\\@llcorner}{\\mathop{\\char"231e}}'),
      Er('\\lrcorner', '\\html@mathml{\\@lrcorner}{\\mathop{\\char"231f}}'),
      Er('\\vdots', '\\mathord{\\varvdots\\rule{0pt}{15pt}}'),
      Er('\u22ee', '\\vdots'),
      Er('\\varGamma', '\\mathit{\\Gamma}'),
      Er('\\varDelta', '\\mathit{\\Delta}'),
      Er('\\varTheta', '\\mathit{\\Theta}'),
      Er('\\varLambda', '\\mathit{\\Lambda}'),
      Er('\\varXi', '\\mathit{\\Xi}'),
      Er('\\varPi', '\\mathit{\\Pi}'),
      Er('\\varSigma', '\\mathit{\\Sigma}'),
      Er('\\varUpsilon', '\\mathit{\\Upsilon}'),
      Er('\\varPhi', '\\mathit{\\Phi}'),
      Er('\\varPsi', '\\mathit{\\Psi}'),
      Er('\\varOmega', '\\mathit{\\Omega}'),
      Er('\\substack', '\\begin{subarray}{c}#1\\end{subarray}'),
      Er(
        '\\colon',
        '\\nobreak\\mskip2mu\\mathpunct{}\\mathchoice{\\mkern-3mu}{\\mkern-3mu}{}{}{:}\\mskip6mu\\relax'
      ),
      Er('\\boxed', '\\fbox{$\\displaystyle{#1}$}'),
      Er('\\iff', '\\DOTSB\\;\\Longleftrightarrow\\;'),
      Er('\\implies', '\\DOTSB\\;\\Longrightarrow\\;'),
      Er('\\impliedby', '\\DOTSB\\;\\Longleftarrow\\;')
    var Dn = {
      ',': '\\dotsc',
      '\\not': '\\dotsb',
      '+': '\\dotsb',
    ...
    Er('\\dots', function (e) {
      ...
      return (
        r in Dn
          ? (t = Dn[r])
          : ('\\not' === r.substr(0, 4) ||
              (r in ae.math && l.contains(['bin', 'rel'], ae.math[r].group))) &&
            (t = '\\dotsb'),
        t
      )
    })
    ...
    Er('\\dotso', function (e) {
      ...
      Er('\\DOTSB', '\\relax'),
      Er('\\DOTSX', '\\relax'),
      Er('\\tmspace', '\\TextOrMath{\\kern#1#3}{\\mskip#1#2}\\relax'),
      Er('\\,', '\\tmspace+{3mu}{.1667em}'),
      Er('\\thinspace', '\\,'),
      Er('\\>', '\\mskip{4mu}'),
      Er('\\:', '\\tmspace+{4mu}{.2222em}'),
      Er('\\medspace', '\\:'),
      Er('\\;', '\\tmspace+{5mu}{.2777em}'),
      Er('\\thickspace', '\\;'),
      Er('\\!', '\\tmspace-{3mu}{.1667em}'),
      Er('\\negthinspace', '\\!'),
      ...
      Er('\\enspace', '\\kern.5em '),
      Er('\\enskip', '\\hskip.5em\\relax'),
      Er('\\quad', '\\hskip1em\\relax'),
      Er('\\qquad', '\\hskip2em\\relax'),
      Er('\\tag', '\\@ifstar\\tag@literal\\tag@paren'),
      Er('\\tag@paren', '\\tag@literal{({#1})}'),
      Er('\\tag@literal', function (e) {
      ...
      Er('\\pod', '\\allowbreak\\mathchoice{\\mkern18mu}{\\mkern8mu}{\\mkern8mu}{\\mkern8mu}(#1)'),
      Er('\\pmod', '\\pod{{\\rm mod}\\mkern6mu#1}'),
      Er(
        '\\mod',
        '\\allowbreak\\mathchoice{\\mkern18mu}{\\mkern12mu}{\\mkern12mu}{\\mkern12mu}{\\rm mod}\\,\\,#1'
      ),
      Er('\\pmb', '\\html@mathml{\\@binrel{#1}{\\mathrlap{#1}\\kern0.5px#1}}{\\mathbf{#1}}'),
      Er('\\newline', '\\\\\\relax'),
      Er('\\TeX', '\\textrm{\\html@mathml{T\\kern-.1667em\\raisebox{-.5ex}{E}\\kern-.125emX}{TeX}}')
    var Fn = V(
      T['Main-Regular']['T'.charCodeAt(0)][1] - 0.7 * T['Main-Regular']['A'.charCodeAt(0)][1]
    )
    Er(
      '\\LaTeX',
      ...
      Er('\\hspace', '\\@ifstar\\@hspacer\\@hspace'),
      Er('\\@hspace', '\\hskip #1\\relax'),
      Er('\\@hspacer', '\\rule{0pt}{0pt}\\hskip #1\\relax'),
      Er('\\ordinarycolon', ':'),
      Er('\\vcentcolon', '\\mathrel{\\mathop\\ordinarycolon}'),
      Er(
        '\\dblcolon',
      ...
      Er('\u2a74', '\\Coloneqq'),
      Er('\\ratio', '\\vcentcolon'),
      Er('\\coloncolon', '\\dblcolon'),
      Er('\\colonequals', '\\coloneqq'),
      Er('\\coloncolonequals', '\\Coloneqq'),
      Er('\\equalscolon', '\\eqqcolon'),
      Er('\\equalscoloncolon', '\\Eqqcolon'),
      Er('\\colonminus', '\\coloneq'),
      Er('\\coloncolonminus', '\\Coloneq'),
      Er('\\minuscolon', '\\eqcolon'),
      Er('\\minuscoloncolon', '\\Eqcolon'),
      Er('\\coloncolonapprox', '\\Colonapprox'),
      Er('\\coloncolonsim', '\\Colonsim'),
      Er('\\simcolon', '\\mathrel{\\sim\\mathrel{\\mkern-1.2mu}\\vcentcolon}'),
      Er('\\simcoloncolon', '\\mathrel{\\sim\\mathrel{\\mkern-1.2mu}\\dblcolon}'),
      Er('\\approxcolon', '\\mathrel{\\approx\\mathrel{\\mkern-1.2mu}\\vcentcolon}'),
      Er('\\approxcoloncolon', '\\mathrel{\\approx\\mathrel{\\mkern-1.2mu}\\dblcolon}'),
      Er('\\notni', '\\html@mathml{\\not\\ni}{\\mathrel{\\char`\u220c}}'),
      Er('\\limsup', '\\DOTSB\\operatorname*{lim\\,sup}'),
      Er('\\liminf', '\\DOTSB\\operatorname*{lim\\,inf}'),
      Er('\\injlim', '\\DOTSB\\operatorname*{inj\\,lim}'),
      Er('\\projlim', '\\DOTSB\\operatorname*{proj\\,lim}'),
      Er('\\varlimsup', '\\DOTSB\\operatorname*{\\overline{lim}}'),
      Er('\\varliminf', '\\DOTSB\\operatorname*{\\underline{lim}}'),
      Er('\\varinjlim', '\\DOTSB\\operatorname*{\\underrightarrow{lim}}'),
      Er('\\varprojlim', '\\DOTSB\\operatorname*{\\underleftarrow{lim}}'),
      Er('\\gvertneqq', '\\html@mathml{\\@gvertneqq}{\u2269}'),
      Er('\\lvertneqq', '\\html@mathml{\\@lvertneqq}{\u2268}'),
      ...
      Er('\\varsubsetneq', '\\html@mathml{\\@varsubsetneq}{\u228a}'),
      Er('\\varsubsetneqq', '\\html@mathml{\\@varsubsetneqq}{\u2acb}'),
      Er('\\varsupsetneq', '\\html@mathml{\\@varsupsetneq}{\u228b}'),
      Er('\\varsupsetneqq', '\\html@mathml{\\@varsupsetneqq}{\u2acc}'),
      Er('\\imath', '\\html@mathml{\\@imath}{\u0131}'),
      Er('\\jmath', '\\html@mathml{\\@jmath}{\u0237}'),
      Er('\\llbracket', '\\html@mathml{\\mathopen{[\\mkern-3.2mu[}}{\\mathopen{\\char`\u27e6}}'),
      Er('\\rrbracket', '\\html@mathml{\\mathclose{]\\mkern-3.2mu]}}{\\mathclose{\\char`\u27e7}}'),
      Er('\u27e6', '\\llbracket'),
      Er('\u27e7', '\\rrbracket'),
      Er('\\lBrace', '\\html@mathml{\\mathopen{\\{\\mkern-3.2mu[}}{\\mathopen{\\char`\u2983}}'),
      Er('\\rBrace', '\\html@mathml{\\mathclose{]\\mkern-3.2mu\\}}}{\\mathclose{\\char`\u2984}}'),
      Er('\u2983', '\\lBrace'),
      Er('\u2984', '\\rBrace'),
      Er(
        '\\minuso',
      ...
      Er('\\Complex', '\\mathbb{C}'),
      Er('\\Dagger', '\\ddagger'),
      Er('\\diamonds', '\\diamondsuit'),
      Er('\\empty', '\\emptyset'),
      Er('\\Epsilon', '\\mathrm{E}'),
      Er('\\Eta', '\\mathrm{H}'),
      Er('\\exist', '\\exists'),
      Er('\\harr', '\\leftrightarrow'),
      Er('\\hArr', '\\Leftrightarrow'),
      Er('\\Harr', '\\Leftrightarrow'),
      Er('\\hearts', '\\heartsuit'),
      Er('\\image', '\\Im'),
      ...
      Er('\\weierp', '\\wp'),
      Er('\\Zeta', '\\mathrm{Z}'),
      Er('\\argmin', '\\DOTSB\\operatorname*{arg\\,min}'),
      Er('\\argmax', '\\DOTSB\\operatorname*{arg\\,max}'),
      Er('\\plim', '\\DOTSB\\mathop{\\operatorname{plim}}\\limits'),
      Er('\\bra', '\\mathinner{\\langle{#1}|}'),
      Er('\\ket', '\\mathinner{|{#1}\\rangle}'),
      Er('\\braket', '\\mathinner{\\langle{#1}\\rangle}'),
      Er('\\Bra', '\\left\\langle#1\\right|'),
      Er('\\Ket', '\\left|#1\\right\\rangle'),
      Er('\\angln', '{\\angl n}'),
      Er('\\blue', '\\textcolor{##6495ed}{#1}'),
      Er('\\orange', '\\textcolor{##ffa500}{#1}'),
      Er('\\pink', '\\textcolor{##ff00af}{#1}'),
      Er('\\red', '\\textcolor{##df0030}{#1}'),
      Er('\\green', '\\textcolor{##28ae7b}{#1}'),
      Er('\\gray', '\\textcolor{gray}{#1}'),
      Er('\\purple', '\\textcolor{##9d38bd}{#1}'),
      Er('\\blueA', '\\textcolor{##ccfaff}{#1}'),
      Er('\\blueB', '\\textcolor{##80f6ff}{#1}'),
      Er('\\blueC', '\\textcolor{##63d9ea}{#1}'),
      Er('\\blueD', '\\textcolor{##11accd}{#1}'),
      Er('\\blueE', '\\textcolor{##0c7f99}{#1}'),
      Er('\\tealA', '\\textcolor{##94fff5}{#1}'),
      Er('\\tealB', '\\textcolor{##26edd5}{#1}'),
      Er('\\tealC', '\\textcolor{##01d1c1}{#1}'),
      Er('\\tealD', '\\textcolor{##01a995}{#1}'),
      Er('\\tealE', '\\textcolor{##208170}{#1}'),
      Er('\\greenA', '\\textcolor{##b6ffb0}{#1}'),
      Er('\\greenB', '\\textcolor{##8af281}{#1}'),
      Er('\\greenC', '\\textcolor{##74cf70}{#1}'),
      Er('\\greenD', '\\textcolor{##1fab54}{#1}'),
      Er('\\greenE', '\\textcolor{##0d923f}{#1}'),
      Er('\\goldA', '\\textcolor{##ffd0a9}{#1}'),
      Er('\\goldB', '\\textcolor{##ffbb71}{#1}'),
      Er('\\goldC', '\\textcolor{##ff9c39}{#1}'),
      Er('\\goldD', '\\textcolor{##e07d10}{#1}'),
      Er('\\goldE', '\\textcolor{##a75a05}{#1}'),
      Er('\\redA', '\\textcolor{##fca9a9}{#1}'),
      Er('\\redB', '\\textcolor{##ff8482}{#1}'),
      Er('\\redC', '\\textcolor{##f9685d}{#1}'),
      Er('\\redD', '\\textcolor{##e84d39}{#1}'),
      Er('\\redE', '\\textcolor{##bc2612}{#1}'),
      Er('\\maroonA', '\\textcolor{##ffbde0}{#1}'),
      Er('\\maroonB', '\\textcolor{##ff92c6}{#1}'),
      Er('\\maroonC', '\\textcolor{##ed5fa6}{#1}'),
      Er('\\maroonD', '\\textcolor{##ca337c}{#1}'),
      Er('\\maroonE', '\\textcolor{##9e034e}{#1}'),
      Er('\\purpleA', '\\textcolor{##ddd7ff}{#1}'),
      Er('\\purpleB', '\\textcolor{##c6b9fc}{#1}'),
      Er('\\purpleC', '\\textcolor{##aa87ff}{#1}'),
      Er('\\purpleD', '\\textcolor{##7854ab}{#1}'),
      Er('\\purpleE', '\\textcolor{##543b78}{#1}'),
      Er('\\mintA', '\\textcolor{##f5f9e8}{#1}'),
      Er('\\mintB', '\\textcolor{##edf2df}{#1}'),
      Er('\\mintC', '\\textcolor{##e0e5cc}{#1}'),
      Er('\\grayA', '\\textcolor{##f6f7f7}{#1}'),
      Er('\\grayB', '\\textcolor{##f0f1f2}{#1}'),
      Er('\\grayC', '\\textcolor{##e3e5e6}{#1}'),
      Er('\\grayD', '\\textcolor{##d6d8da}{#1}'),
      Er('\\grayE', '\\textcolor{##babec2}{#1}'),
      Er('\\grayF', '\\textcolor{##888d93}{#1}'),
      Er('\\grayG', '\\textcolor{##626569}{#1}'),
      Er('\\grayH', '\\textcolor{##3b3e40}{#1}'),
      Er('\\grayI', '\\textcolor{##21242c}{#1}'),
      Er('\\kaBlue', '\\textcolor{##314453}{#1}'),
      Er('\\kaGreen', '\\textcolor{##71B307}{#1}')
    var Vn = { '^': !0, _: !0, '\\limits': !0, '\\nolimits': !0 },
      Gn = (function () {
        function e(e, t, r) {
          ;(this.settings = void 0),
            ...
            this.feed(e),
            (this.macros = new On(Hn, t.macros)),
            (this.mode = r),
            (this.stack = [])
        }
        var t = e.prototype
        return (
          ...
          (t.scanArgument = function (e) {
            ...
            return this.pushToken(new Dr('EOF', r.loc)), this.pushTokens(n), t.range(r, '')
          }),
          ...
          (t.expandNextToken = function () {
            for (;;) {
              ...
              if (e instanceof Dr) return e.treatAsRelax && (e.text = '\\relax'), this.stack.pop()
            }
            throw new Error()
          }),
          (t.expandMacro = function (e) {
            return this.macros.has(e) ? this.expandTokens([new Dr(e)]) : void 0
          }),
          (t.expandTokens = function (e) {
            ...
            for (this.pushTokens(e); this.stack.length > r; ) {
              ...
              n instanceof Dr &&
                (n.treatAsRelax && ((n.noexpand = !1), (n.treatAsRelax = !1)),
          ...
          (t._getExpansion = function (e) {
            ...
            if ('string' == typeof n) {
              ...
              for (var o = new Rn(n, this.settings), s = [], l = o.lex(); 'EOF' !== l.text; )
                s.push(l), (l = o.lex())
          ...
          (t.isDefined = function (e) {
            return (
              this.macros.has(e) ||
              Nn.hasOwnProperty(e) ||
              ae.math.hasOwnProperty(e) ||
              ae.text.hasOwnProperty(e) ||
              Vn.hasOwnProperty(e)
            )
          }),
          (t.isExpandable = function (e) {
            ...
            return null != t
              ...
              : Nn.hasOwnProperty(e) && !Nn[e].primitive
          }),
          e
        )
      })(),
      ...
      Xn = (function () {
        function e(e, t) {
          ;(this.mode = void 0),
            ...
            (this.mode = 'math'),
            (this.gullet = new Gn(e, t, this.mode)),
            (this.settings = t),
        ...
        return (
          ...
          (t.subparse = function (e) {
            ...
            this.consume(), this.gullet.pushToken(new Dr('}')), this.gullet.pushTokens(e)
          ...
          (t.parseAtom = function (e) {
              ...
              if ('\\limits' === i.text || '\\nolimits' === i.text) {
                if (a && 'op' === a.type) {
                  ...
                  if (!a || 'operatorname' !== a.type)
                    throw new n('Limit controls must follow a math operator', i)
            ...
            return t || r ? { type: 'supsub', mode: this.mode, base: a, sup: t, sub: r } : a
          }),
          ...
          (t.parseRegexGroup = function (e, t) {
            for (
              var r, a = this.fetch(), i = a, o = '';
              'EOF' !== (r = this.fetch()).text && e.test(o + r.text);
          ...
          (t.parseSizeGroup = function (e) {
            ...
            if (!P(i)) throw new n("Invalid unit: '" + i.unit + "'", t)
          ...
          (t.parseSymbol = function () {
            ...
            if (
              ...
              var s,
                l = ae[this.mode][t].group,
                h = Lr.range(e)
              if (te.hasOwnProperty(l)) {
                var m = l
                s = { type: 'atom', mode: this.mode, family: m, loc: h, text: t }
              ...
              this.settings.strict &&
                ...
                (i = { type: 'textord', mode: 'text', loc: Lr.range(e), text: t })
            }
            if ((this.consume(), o))
              for (var c = 0; c < o[0].length; c++) {
                var u = o[0][c]
                if (!Un[u]) throw new n("Unknown accent ' " + u + "'", e)
                var p = Un[u][this.mode] || Un[u].text
    ...
    Xn.endOfExpression = ['}', '\\endgroup', '\\end', '\\right', '&']
    var Wn = function (e, t) {
        ...
        if (
          ...
          a = [{ type: 'tag', mode: 'text', body: a, tag: r.subparse([new Dr('\\df@tag')]) }]
        }
        return a
      },
      _n = function (e, t, r) {
    ...
    var jn = function (e, t, r) {
        ...
        return (
          a.setAttribute('title', e.toString()), a.setAttribute('style', 'color:' + r.errorColor), a
        )
      },
      $n = function (e, t) {
        var r = new c(t)
      ...
      Zn = {
        ...
        __defineSymbol: ie,
        __defineMacro: Er,
        __domTree: { Span: W, Anchor: _, SymbolNode: Z, SvgNode: K, PathNode: J, LineNode: Q }
      }
    return (t = t.default)
  })()
})
