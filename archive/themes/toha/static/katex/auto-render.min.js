        ...
        var e = n(771),
          ...
          o = function (e, t) {
            for (
              ...
              var d = e.slice(0, n + t[l].right.length),
                s = i.test(d) ? d : e.slice(t[l].left.length, n)
              a.push({ type: 'math', data: s, rawData: d, display: t[l].display }),
          ...
          l = function (e, r) {
            ...
            for (var a = document.createDocumentFragment(), i = 0; i < n.length; i++)
              if ('text' === n[i].type) a.appendChild(document.createTextNode(n[i].data))
              else {
                ...
                try {
                  ...
                  r.errorCallback(
                    'KaTeX auto-render: Failed to parse `' + n[i].data + '` with ',
                    e
                  ),
                    a.appendChild(document.createTextNode(n[i].rawData))
                  continue
                }
                a.appendChild(l)
              }
          ...
          d = function e(t, r) {
            for (var n = 0; n < t.childNodes.length; n++) {
              ...
              if (3 === a.nodeType) {
                var i = l(a.textContent, r)
                i && ((n += i.childNodes.length - 1), t.replaceChild(i, a))
              } else
                1 === a.nodeType &&
                  (function () {
                    var t = ' ' + a.className + ' '
