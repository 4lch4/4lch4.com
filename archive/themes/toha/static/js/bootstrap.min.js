      ...
      (ot = (function () {
        ...
        return (
          ...
          (t._getItemIndex = function (t) {
            return (
              (this._items =
                t && t.parentNode ? [].slice.call(t.parentNode.querySelectorAll(tt)) : []),
    ...
    Bn =
      ...
      (Tt = (function () {
        function a(e, t) {
          ...
          for (
            var n = [].slice.call(document.querySelectorAll(Ct)), i = 0, r = n.length;
            i < r;
            i++
          ) {
            var o = n[i],
              ...
              if ((st(this._element).trigger(i), !i.isDefaultPrevented())) {
                ...
                st(this._element).removeClass(_t).addClass(mt),
                  ...
                  this._triggerArray.length &&
                    st(this._triggerArray).removeClass(pt).attr('aria-expanded', !0),
        ...
        return (
          ...
          (c._jQueryInterface = function (e) {
            return this.each(function () {
              ...
              if (
                (t || ((t = new c(this, 'object' == typeof e ? e : null)), bt(this).data(It, t)),
                'string' == typeof e)
              ) {
          ...
          (c._clearMenus = function (t) {
            if (!t || (3 !== t.which && ('keyup' !== t.type || 9 === t.which)))
              for (
                var e = [].slice.call(document.querySelectorAll(Wt)), n = 0, i = e.length;
                n < i;
                n++
              ) {
                  ...
                  if (
                    ...
                    bt(r).trigger(l),
                      l.isDefaultPrevented() ||
                        ('ontouchstart' in document.documentElement &&
                          bt(document.body).children().off('mouseover', null, bt.noop),
            ...
            if (
              (/input|textarea/i.test(t.target.tagName)
                ? !(
                    32 === t.which ||
                    (27 !== t.which &&
                      ((40 !== t.which && 38 !== t.which) || bt(t.target).closest(qt).length))
                  )
                : Nt.test(t.which)) &&
        ...
        return (
          ...
          (n._jQueryInterface = function (e) {
            return this.each(function () {
              ...
              if (
                (t || ((t = new n(this, 'object' == typeof e && e)), tn(this).data(nn, t)),
                'string' == typeof e)
              ) {
                if ('undefined' == typeof t[e]) throw new TypeError('No method named "' + e + '"')
                t[e]()
