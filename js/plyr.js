  ...
  (function (e, t) {
          ...
          [
            {
              ...
              value: function (t) {
                ...
                if (
                  (v(t) || p(t)
                    ? (s = Array.from(document.querySelectorAll(p(t) ? t : 'input[type="range"]')))
                    : y(t)
                    ? (s = [t])
                    : f(t)
                    ? (s = Array.from(t))
    ...
    function le(e, t, i) {
      ...
      if (H(e)) {
        let s = 'toggle'
        return (
          void 0 !== i && (s = i ? 'add' : 'remove'), e.classList[s](t), e.classList.contains(t)
        )
      }
      return !1
    }
      ...
      me = {
        ...
        pip: !(
          ...
          (!q(Z('video').webkitSetPresentationMode) &&
            (!document.pictureInPictureEnabled || Z('video').disablePictureInPicture))
        ),
      ...
      pe && (o = { passive: n, capture: a }),
        l.forEach(t => {
          this &&
            this.eventListeners &&
            s &&
            this.eventListeners.push({ element: e, type: t, callback: i, options: o }),
    ...
    function Te() {
      return new Promise(e =>
        this.ready ? setTimeout(e, 0) : fe.call(this, this.elements.container, 'ready', e)
      ).then(() => {})
    }
    function ke(e) {
      B(e) && e.then(null, () => {})
    ...
    function Me(e) {
      ...
      if (
        ...
        null === i && !W(this.embed) && j(this.embed.ratio) && ({ ratio: i } = this.embed),
        null === i && this.isHTML5)
      ) {
    ...
    const _e = (e = '', t = '', i = '') =>
      ...
      Oe = (e = '') =>
        e.toString().replace(/\w\S*/g, e => e.charAt(0).toUpperCase() + e.substr(1).toLowerCase())
    function qe(e = '') {
      let t = e.toString()
      return (
        (t = (function (e = '') {
    ...
    function Ve(e, t) {
      ...
      if (!i || !n()) {
        ...
        Re(e)
          .then(e => {
            W(e) ||
              (n && window.localStorage.setItem(`cache-${t}`, JSON.stringify({ content: e })),
              a(l, e))
          })
          .catch(() => {})
      }
    ...
    const We = {
      ...
      createIcon(e, t) {
        ...
        const l = document.createElementNS(i, 'use'),
          o = `${n}-${e}`
        return (
          'href' in l && l.setAttributeNS('http://www.w3.org/1999/xlink', 'href', o),
            ...
            if (!s && [32, 39].includes(i.which)) We.showMenuPanel.call(this, t, !0)
              ...
              32 !== i.which &&
                (40 === i.which || (s && 39 === i.which)
                  ? ((t = e.nextElementSibling), H(t) || (t = e.parentNode.firstElementChild))
                  : ((t = e.previousElementSibling), H(t) || (t = e.parentNode.lastElementChild)),
                ue.call(this, t, !0))
            }
          },
          !1
      ...
      updateVolume() {
        this.supported.ui &&
          (H(this.elements.inputs.volume) &&
            We.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
      ...
      durationUpdate() {
        ...
        !e &&
          ...
          this.paused &&
          We.updateTimeDisplay.call(this, this.elements.display.currentTime, this.duration),
          ...
          const e = We.getMenuSize.call(this, i),
            t = e => {
              e.target === s &&
                ...
                ((s.style.width = ''), (s.style.height = ''), ye.call(this, s, z, t))
            }
          fe.call(this, s, z, t),
      ...
      create(e) {
        ...
        return (
          Ce(j(this.config.controls) ? this.config.controls : []).forEach(l => {
            ...
            if (
              ('current-time' === l && c.appendChild(a.call(this, 'currentTime', h)),
              ...
              if (
                ((H(t) && c.contains(t)) ||
                  ((t = Z('div', X({}, h, { class: `${h.class} plyr__volume`.trim() }))),
                ...
                this.config.settings.forEach(i => {
                  ...
                  h.appendChild(Z('span', { 'aria-hidden': !0 }, He.get(i, this.config))),
                    ...
                    fe.call(
                      ...
                      e => {
                        37 === e.which &&
                          (e.preventDefault(), e.stopPropagation(), r.call(this, 'home', !0))
                      },
                      !1
                    ),
      ...
      inject() {
        ...
        if (
          (s[H(e) ? 'insertAdjacentElement' : 'insertAdjacentHTML']('afterbegin', e),
        ...
        setup() {
          ...
          if (
            (H(this.elements.captions) ||
              ((this.elements.captions = Z('div', ne(this.config.selectors.captions))),
    ...
    class st {
      ...
      static get prefix() {
        ...
        return (
          ['webkit', 'moz', 'ms'].some(
            t =>
              !(!q(document[`${t}ExitFullscreen`]) && !q(document[`${t}CancelFullScreen`])) &&
              ((e = t), !0)
          ),
          e
        )
    ...
    const at = {
      ...
      toggleControls(e) {
        ...
        if (t && this.config.hideControls) {
          ...
          this.toggleControls(
            Boolean(e || this.loading || this.paused || t.pressed || t.hover || i)
          )
        }
      },
      migrateStyles() {
    ...
    class lt {
        ...
        e(this, 'firstTouch', () => {
              ...
              'focusout' !== e.type &&
                (this.focusTimer = setTimeout(() => {
                  ...
                  i.container.contains(e) &&
                    le(document.activeElement, t.config.classNames.tabFocus, !0)
                }, 10)))
          }),
          e(this, 'global', (e = !0) => {
            const { player: t } = this
          ...
          e(this, 'media', () => {
            ...
            if (
              ...
              fe.call(e, e.media, 'durationchange loadeddata loadedmetadata', t =>
                We.durationUpdate.call(e, t)
              ),
              ...
              fe.call(e, e.media, 'playing play pause ended emptied timeupdate', t =>
                at.checkPlaying.call(e, t)
              ),
            ...
            if (
              ...
              this.bind(
                ...
                t => {
                  ...
                  ;[13, 32].includes(i) &&
                    (13 !== i
                      ? (t.preventDefault(), t.stopPropagation(), We.toggleMenu.call(e, t))
              ...
              this.bind(t.inputs.seek, 'mousedown mouseup keydown keyup touchstart touchend', t => {
                ...
                a && l
                  ...
                  : !l && e.playing && (i.setAttribute(n, ''), e.pause())
              }),
              Y.isIos)
            ) {
            ...
            this.bind(
              ...
              e.config.toggleInvert &&
                ...
                this.bind(t.display.currentTime, 'click', () => {
                  0 !== e.currentTime &&
                    ((e.config.invertTime = !e.config.invertTime), We.timeUpdate.call(e))
                }),
              this.bind(
                t.inputs.volume,
                i,
      ...
      handleKey(e) {
        ...
        if (n) {
          ...
          switch (
            ([
              32, 37, 38, 39, 40, 48, 49, 50, 51, 52, 53, 54, 56, 57, 67, 70, 73, 75, 76, 77, 79
    ...
    function ct(e) {
      e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
        this.media.paused === e &&
          ((this.media.paused = !e), ve.call(this, this.media, e ? 'play' : 'pause'))
    }
    const ht = {
      setup() {
        const e = this
            ...
            events: {
                ...
                ;(e.options.speed = o.filter(t => e.config.speed.options.includes(t))),
                  ...
                  (e.timers.buffering = setInterval(() => {
                    ;(e.media.buffered = s.getVideoLoadedFraction()),
                      ...
                      1 === e.media.buffered &&
                        (clearInterval(e.timers.buffering), ve.call(e, e.media, 'canplaythrough'))
                  }, 200)),
              ...
              onStateChange(i) {
                ...
                switch (
                  ...
                  case 0:
                    ut.call(e, !1),
                      e.media.loop ? (s.stopVideo(), s.playVideo()) : ve.call(e, e.media, 'ended')
                    break
                  case 1:
        ...
        e(this, 'load', () => {
          ...
          e(this, 'onAdsManagerLoaded', e => {
            ...
            ;(t.restoreCustomPlaybackStateOnAdBreakComplete = !0),
              ...
              this.manager.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR, e =>
                this.onAdError(e)
              ),
          ...
          e(
            this,
            'on',
            (e, t) => (j(this.events[e]) || (this.events[e] = []), this.events[e].push(t), this)
          ),
          ...
          this.player.elements.display.seekTooltip &&
            ...
            this.enabled &&
              this.getThumbnails().then(() => {
                this.enabled &&
                  (this.render(), this.determineContainerAutoSizing(), (this.loaded = !0))
              })
        }),
          e(
            this,
          ...
          e(this, 'setThumbContainerSizeAndPos', () => {
            if (this.sizeSpecifiedInCSS) {
              if (
                ...
                const e = Math.floor(
                  this.elements.thumb.imageContainer.clientHeight * this.thumbAspectRatio
                )
                ...
                const e = Math.floor(
                  this.elements.thumb.imageContainer.clientWidth / this.thumbAspectRatio
                )
    ...
    class wt {
      constructor(t, i) {
        if (
            ...
            this.stop(),
              ...
              this.isHTML5
                ...
                ? (clearInterval(this.timers.buffering),
                  ...
                  null !== this.embed && q(this.embed.destroy) && this.embed.destroy(),
                  i())
                : this.isVimeo &&
          ...
          ((window.jQuery && this.media instanceof jQuery) || D(this.media) || j(this.media)) &&
