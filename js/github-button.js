function renderGithubButton() {
  ...
  var e = window.document,
    ...
    k = function (e, t, o) {
      ...
      if (('' === f[0] && f.shift(), 'com' !== f[0] || 'github' !== f[1]))
        return (d.href = '#'), (d.target = '_self'), void o(s)
      var u = f.length,
        g = (' /' + d.pathname).split(/\/+/)
      if (
        ((((2 === u || (3 === u && 'gist' === f[2])) && 'archive' === g[3]) ||
          (2 === u && 'releases' === g[3] && 'download' === g[4]) ||
          (3 === u && 'codeload' === f[2])) &&
          (d.target = '_top'),
        /^true$/i.test(t['data-show-count']) && 2 === u)
      ) {
        var p, x
  ...
  t.protocol + '//' + t.host + t.pathname === a
    ? k(e.body, c(window.name || t.hash.replace(/^#/, '')), function () {})
    : (function (t) {
        if (/m/.test(e.readyState) || (!/g/.test(e.readyState) && !e.documentElement.doScroll))
          setTimeout(t)
